...
class PP_Credit_Scholar_Model extends CI_Model
{
	...
	public function get_temp_applicationformdata(){		
		...
		$query=$this->db->select('application_no,ip_address,loan_type,loan_amt,loan_interest,loan_term,loan_schedule,loan_fee,loan_tax,loan_commission,loan_guarantee')
			->from('temp_applicationform')
			->where('status', 1)
