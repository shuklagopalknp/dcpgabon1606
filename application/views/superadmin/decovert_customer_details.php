                            ...
                            <h3 id="tab-title"><span><?php echo ucwords("Frais De Dossier"); ?></span></h3>
                              ...
                              <form id="fraisDeDossierForm_tab22" action="#"  method="post">
                                ...
                                <div class="col-md-3">
                                  ...
                                  <input type="number" class="form-control" id="frais_de_doss1" name="frais_de_doss" autocomplete="off" value="<?php echo $otherinfo[0]['frais_de_dossier'];?>" required min="0" >
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <label>Frais D'Assurance</label>
                                    <div class="input-group">
                                    <span class="input-group-addon">CFA</span>
                                  <input type="number" class="form-control" id="frais_de_assurance1" name="frais_de_assurance" autocomplete="off" value="<?php echo $otherinfo[0]['field_4'];?>" required min="0" >
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-12">
                                  ...
                                  <input type="text"  id="editid1" name="editid"  value="<?php echo $urlid;?>" readonly>

                                  <input type="text"  id="ecustomar_id1" name="ecustomar_id"  value="<?php echo $pinfo[0]['customar_id'];?>" readonly>
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                     <input type="text" placeholder="dd-mm-yyyy" name="dob" class="dob" value="<?php echo date('d-m-Y', strtotime($pinfo[0]['dob'])) ?>" readonly="">  
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                       <input type="text" name="main_phone" class="phone_main_c" value="<?php echo $adinfo[0]['main_phone'] ?>">
                                      </span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                       <input type="text" name="alternative_phone" class="phone_alternate_c" value="<?php echo $adinfo[0]['alternative_phone'] ?>">
                                      </span></h3>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                               <input type="text" placeholder="dd-mm-yyyy" name="expiration_date_id" class="expiration_date" value="<?php echo date('d-m-Y', strtotime($adinfo[0]['expiration_date_id'])) ?>" readonly="">  
                                      </span></h3>
                                    </div>
                                  </div>  
                                <div class="col-md-3">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                       <input type="text" placeholder="dd-mm-yyyy" name="employment_date" value="<?php echo date('d-m-Y', strtotime($empinfo[0]['employment_date'])) ?>" class="employment_date" readonly="">  
                                  </span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <input type="text" name="how_he_is_been_with_current_employer" value="<?php echo $empinfo[0]['how_he_is_been_with_current_employer'] ?>" class="current_emp" readonly="" >
                                   <?php }elseif($years!=0) { ?>
                                   <input type="text" name="how_he_is_been_with_current_employer" value="<?php echo $years?>" class="current_emp" readonly="" >  
                                        <?php }else {?>
                                       <input type="text" name="how_he_is_been_with_current_employer" value="$months" class="current_emp" readonly="">  
                                            <?php }?>    
                                        </span></h3>
                                    </div>
                                  </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Numéro de téléphone principal </label>
                <h3 id="tab-details"><span>
           <input type="text" name="main_phone" id="phone2" class="phone_main_c" value="<?php echo $adinfo[0]['main_phone'] ?>">            
               </span>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Second Numéro de téléphone </label>
                <h3 id="tab-details"><span>
        <input type="text" name="alternative_phone" id="phone_alt2" class="phone_alternate_c" value="<?php echo $adinfo[0]['alternative_phone'] ?>">               
               </span>
...
$(document).ready(function(){
 ...
 $("#frais_btn").on("click", function(e) {
   ...
   $("#frais_btn22").on("click", function(e) {
    ...
    var serializedFormStr =  "frais_de_doss="+ $("#frais_de_doss1").val() + "&frais_de_assurance="+$("#frais_de_assurance1").val()+"&editid="+$("#editid1").val()+"&ecustomar_id="+$("#ecustomar_id1").val();
