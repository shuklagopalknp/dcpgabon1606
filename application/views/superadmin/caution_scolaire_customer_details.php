          ...
          <div class="tab-pane fade in" id="tab2">
            <div class="row" style="margin-top:0px;">
              <div class="col-lg-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="nextstep-buttons">
                                  ...
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="text-align:center">
                                    <loan-back> <a href="<?php echo base_url('PP_Caution_Scolare_Loans/amortization_decovert_views/').$appformD[0]['cl_aid'];?>" class="btn btn-default loan-back"  style="width:100%;margin-top:25px;">AMORTISSMENT</a> </loan-back>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <form action="<?php echo base_url('PP_Caution_Scolare_Loans/customer_details_update')?>"  method="post">          
                   <input type="text" name="first_name" value="<?php echo ($pinfo[0]['first_name']) ?>">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="id_number" value="<?php echo $stinfo[0]['id_number'] ?>">         
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label> Prénoms </label>
                                      <h3 id="tab-details"><span>
                      <input type="text" name="sfirst_name" value="<?php echo $stinfo[0]['first_name'] ?>"> 
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Nom</label>
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="slast_name" value="<?php echo $stinfo[0]['last_name'] ?>">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Date de naissance </label>
                                      <h3 id="tab-details"><span>
                                      <input type="text" placeholder="dd-mm-yyyy" class="stu_dob" name="date_of_birth" value="<?php echo date('d-m-Y', strtotime($stinfo[0]['date_of_birth']. "+132 months")) ?>">        
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="occupation" value="<?php echo $stinfo[0]['occupation'] ?>">      
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="main_phone"  class="phone_main_c" value="<?php echo $stinfo[0]['main_phone'] ?>">     
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="alternative_phone" class="phone_alternate_c" value="<?php echo $stinfo[0]['alternative_phone'] ?>"> 
                                      </span></h3>
                                    </div>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" class="expiration_date" placeholder="dd-mm-yyyy" name="expiration_date_id" value="<?php echo date('d-m-Y', strtotime($stinfo[0]['expiration_date_id'])) ?>" readonly="">  
                                      </span></h3>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                  <input type="text" name="ac_field_1" value="<?php echo $acinfo[0]['field_1'] ?>">         
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                           <input type="text" name="ac_field_2" value="<?php echo $acinfo[0]['field_2'] ?>">        
                                      </span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Clé RIB </label>
                                      <h3 id="tab-details"><span>
                            <input type="text" name="ac_field_3" value="<?php echo $acinfo[0]['field_3'] ?>">  
                                      </span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="ac_field_4" value="<?php echo $acinfo[0]['field_4'] ?>">   
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Code de la banque </label>
                                      <h3 id="tab-details"><span>
                             <input type="text" name="field_1" value="<?php echo $bainfo[0]['field_1'] ?>">   
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Code de l’agence </label>
                                      <h3 id="tab-details"><span>
                                <input type="text" name="field_2" value="<?php echo $bainfo[0]['field_2'] ?>">       
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Clé RIB </label>
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="field_3" value="<?php echo $bainfo[0]['field_3'] ?>">      
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>numéro de compte</label>
                                      <h3 id="tab-details"><span>
                                      <input type="text" name="field_4" value="<?php echo $bainfo[0]['field_4'] ?>">   
                                ...
                                <div class="row">
                                  ...
                                  <div class="row" style="margin-top: 1%">
                                   <h3 id="tab-title"><span>Information Sur l'EmploiI</span><i class="fa fa-plus pull-right" aria-hidden="true"></i></h3>
                   ...
                   <input type="hidden" name="id" value="<?php echo $loandetails[0]['cl_aid'] ?>">    
                  <input type="hidden" name="oid" value="<?php echo $otherinfo[0]['oid'] ?>"> 
                   <input type="hidden" name="cid" value="<?php echo $customersd[0]['cid'] ?>">           <input type="hidden" name="cbk_id" value="<?php echo $bankinfo[0]['cbk_id'] ?>"> 
                   ...
                   <input type="hidden" name="aci_id" value="<?php echo $acinfo[0]['aci_id'] ?>">
                   ...
                   <input type="hidden" name="baci_id" value="<?php echo $bainfo[0]['baci_id'] ?>">
                   <input type="hidden" name="st_id" value="<?php echo $stinfo[0]['st_id'] ?>">             
                   ...
                   <input type="hidden" name="loantype" value="<?php echo $appformD[0]['loantype'] ?>">                  
                              ...
                              <div class="tab-pane fade" id="tab-2">
                                <h3 id="tab-title"><span>SECTION DOCUMENTS</span></h3>
                                <small class="outputmsg"></small>
                                <div class="row">
                                  <div class="col-lg-12">
                                  
                                 <?php if($appformD[0]['final_confirmation']!="Disbursement"){ ?>
                                      <label class="btn-bs-file btn-sm btn-primary" style="border-radius:25px;height:32px;">
                                        <i class="fa fa-upload"></i> Upload <img src="<?php echo base_url("assets/img/loading.gif");?>" class="uploaded_image" style="display:none">
                                ...
                                <table class="table table-bordered table-hover" id="table_auto">
                                  <tr id="row_0">
                                    <td>
                                      ...
                                      <div class="row">
                                        <div class="col-lg-12"> <span><a href="JavaScript:void(0);" onClick="javascript:window.open('<?php echo base_url('PP_Caution_Scolare_Loans/number_5/').$appformD[0]['cl_aid'];?>','Windows','width=802,height=450,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,location=no,directories=no,status=no');return">3- Attestation de virement irrévocable (caution d’études)  </a></span> 
                                        </div>
                                      </div>  
                                      </form>
                                    </td>
                                  ...
                                  <tr id="row_0">
                                    <td>
                                      <form action="#">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6"> <a href="#">3- Accord préalable d'inscriotion</a>
                                          </div>
                                          <div class="col-lg-6">
                                            <div class="form-group">
                                              <div class="radio" style="display:inline-block">
                              ...
                              <div class="tab-pane fade" id="tab-4">
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    <?php } else { ?>
                                        <button type="button" class="btn btn-sm btn-default preview" data-toggle="modal" data-target="#blankmodal" id="notification_Analysispreview"> <i class="fa fa-eye"></i> Preview</button>
                                        <button type="button" class="btn btn-sm btn-primary download" id="notification_analysis_download"><i class="fa fa-cloud-download" data-toggle="modal" data-target="#blankmodal"></i> Download</button>
                                    <?php }?>                                   
                                  </div>
                                </div>
                                <table class="table table-bordered table-hover" id="table_auto">
                          ...
                          <!-- End Tab-3 -->
                              <div class="tab-pane fade" id="tab-6">
                                ...
                                <div class="Email" style="display:block">
                                    ...
                                    <form id="customSendmail1" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="col-md-12 ">
                                        <div class="clearfix" style="margin-top:10px;margin-bottom:10px;">
                                          ...
                                          <input type="hidden" name="manager_id"  value="<?php echo $appformD[0]['admin_id'];?>" readonly>
                                  ...
                                  <textarea class="rowdata" rows="10" style="width: 100%; display: none;"></textarea>
                                  <div class="col-lg-12">
                                    <div class="scrollable" style="">
                                      <div class="table-responsive">
          ...
          <div class="action-panel">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="nextstep-buttons">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="text-align:center">
                        <loan-back>
                            <a href="<?php echo base_url('PP_Caution_Scolare_Loans/amortization_decovert_views/').$appformD[0]['cl_aid'];?>" class="btn btn-default loan-back"  style="width:100%;margin-top:25px;">AMORTISSMENT</a>
                        </loan-back>
                    </div>
                </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Date de naissance </label>
                <h3 id="tab-details"><span>
     <input type="text" placeholder="dd-mm-yyyy" class="stu_dob" name="date_of_birth" value="<?php echo date('d-m-Y', strtotime($stinfo[0]['date_of_birth']. "+132 months")) ?>" readonly="">           
               </span></h3>
              </div>
            </div>
            <div class="col-md-3">
       ...
       <input type="text" name="occupation" value="<?php echo $stinfo[0]['occupation'] ?>">         
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Numéro de téléphone principal </label>
                <h3 id="tab-details"><span>
      <input type="text" name="main_phone"  id="phone2" class="phone_main_c" value="<?php echo $stinfo[0]['main_phone'] ?>">          
                </span>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Second Numéro de téléphone </label>
                <h3 id="tab-details"><span>
      <input type="text" name="alternative_phone" id="phone_alt2" class="phone_alternate_c" value="<?php echo $stinfo[0]['alternative_phone'] ?>">          
              </span>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Expiration Date </label>
                <h3 id="tab-details"><span>
      <input type="text" placeholder="dd-mm-yyyy" class="expiration_date" name="expiration_date_id" value="<?php echo date('d-m-Y', strtotime($stinfo[0]['expiration_date_id'])) ?>" readonly="">          
               </span></h3>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Code de la banque </label>
                <h3 id="tab-details"><span>
       <input type="text" name="field_1" value="<?php echo $bainfo[0]['field_1'] ?>">  </span></h3>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Code de l’agence </label>
                <h3 id="tab-details"><span> 
  <input type="text" name="field_2" value="<?php echo $bainfo[0]['field_2'] ?>">  </span></h3>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>Clé RIB </label>
                <h3 id="tab-details"><span> 
  <input type="text" name="field_3" value="<?php echo $bainfo[0]['field_3'] ?>">  </span></h3>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <label>numéro de compte</label>
                <h3 id="tab-details"><span>
           <input type="text" name="field_4" value="<?php echo $bainfo[0]['field_4'] ?>">  </span></h3>
              </div>
            </div>
             <div class="col-md-3">
              <div class="form-group">
            ...
            <div class="col-md-12">
               ...
               <div class="text-center">
                  ...
                  <input type="hidden" name="oid" value="<?php echo $otherinfo[0]['oid'] ?>"> 
                   ...
                   <input type="hidden" name="add_id" value="<?php echo $adrs[0]['add_id'] ?>">
                   <input type="hidden" name="emp_infoid" value="<?php echo $empinfo[0]['emp_infoid'] ?>">
                   <input type="hidden" name="ai_id" value="<?php echo $acinfo[0]['ai_id'] ?>">
                   <input type="hidden" name="pid" value="<?php echo $pinfo[0]['pid'] ?>">
                   <input type="hidden" name="bmid" value="<?php echo $decision_rec[0]['bmid'] ?>">
                   <input type="hidden" name="applicableid" value="<?php echo $applicableloanratio[0]['applicableid'] ?>">
                   <input type="hidden" name="tc_id" value="<?php echo $contract_type[0]['tc_id'] ?>">
  ...
  $('#type_id').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            ...
            data:{'ai_id':ai_id,'customar_id':customar_id,'cl_aid':cl_aid,'select_val': select_val },
             beforeSend: function(){
  ...
  $('#cat_employeurs').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            ...
            data:{'emp_infoid':emp_infoid,'customar_id':customar_id,'cl_aid':cl_aid,'select_val': select_val },
             beforeSend: function(){
   ...
   $("#frais_de_dossier").css("background-color", "#e9ffe9");
    ...
    $.ajax({
      type: "POST", 
        ...
        data:{'id':editid,'data':getval,'cl_aid':cl_aid},     
        beforeSend: function(){   
...
$(document).ready(function(){   
    $(document).on('change', '#systemdocsfiles', function(){
      ...
      var customar_id ='<?php echo $appformD[0]['customar_id'];?>';
      var loan_type ='<?php echo $appformD[0]['loan_type'];?>';             
      ...
      var fsize = f.size||f.fileSize;        
          ...
          form_data.append('loan_type_id',loan_type);
    ...
    $(document).on('change', '#check_list_customer_documents', function(){
        ...
        var loan_type2 ='<?php echo $appformD[0]['loan_type'];?>'; 
      ...
      oFReader.readAsDataURL(document.getElementById("check_list_customer_documents").files[0]);
        ...
        var fsize = f.size||f.fileSize;            
            ...
            form_data.append('loan_type_id',loan_type2);
...
$(document).ready(function(){       
    $(document).on('change', '#risk_analysisfiles2', function(){        
      ...
      var admin_id ='<?php echo $appformD[0]['admin_id'];?>';
      var customar_id ='<?php echo $appformD[0]['customar_id'];?>'; 
      var loan_type3='<?php echo $appformD[0]['loan_type'];?>';  
      ...
      var form_data = new FormData();
        ...
        form_data.append('admin_id', admin_id);
        form_data.append('customar_id', customar_id);
        form_data.append('loan_type_id', loan_type3); 
        for(var i = 0; i < namer.length; i++) {             
...
<script type="text/javascript">
  $("#commentsubmit").on("click", function(e) {    
    var form = $("#DecisionStatus");           
     ...
     $.ajax({
        type:'POST',
        url:'<?php echo base_url("PP_Caution_Scolare_Loans/comment_manager");?>',
        data: $.trim(serializedFormStr),
        beforeSend: function(){         
