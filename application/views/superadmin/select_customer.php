				...
				<div class="col-lg-12">
					<div id="content-header" class="clearfix">
						...
						<ol class="breadcrumb">
								...
								<li><a href="#">CREDIT SCHOLAIRE</a></li>
													...
													<tbody id="callsearch">
														...
														//echo "<pre>", print_r($key), "</pre>";
														 ?>
															...
															<td><a href="javascript:void(0);"   data-toggle="modal" data-target="#EditCustomerModal"><?php echo $key['first_name'].' '.$key['middle_name'].' '.$key['last_name'];?></a></td>
		   ...
		   <form role="form" method="post" id="addnewcustomer">
				<div class="modal-body">   
					...
					<fieldset>
		                ...
		                <div class="row">
		                  ...
		                  <div class="col-md-3">
		                    <div class="form-group">
		                      <label>Email</label>
		                      <input type="email"  class="form-control addvalidate" id="email" name="email" plEmailaceholder="eg:example@domain.com" required value=""/>
		                    </div>
		                  </div>
		                </div> 
		                <hr />
					...
					<fieldset>
						...
						<div class="row">
		                  <div class="col-md-3">
		                    <div><label>Type d’identification</label>
		                  ...
		                  <div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text"  class="form-control addvalidate" id="room_type" name="room_type" placeholder="" required value=""/>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Nom et Prénoms du PERE</label>
									<input type="text"  class="form-control addvalidate" id="father_fullname" name="father_fullname" placeholder="" required value=""/>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label>Noms et Prénoms  de la MERE</label>
									<input type="text"  class="form-control addvalidate" id="mother_fullname" name="mother_fullname" placeholder="" required value=""/>
								</div>
							</div>						  
		                </div> 
					</fieldset>
					<fieldset>
						<legend>Information Sur l'EmploiI</legend>
						<div class="row">
		                  <div class="col-md-3">
		                    <div class="form-group">
						...
						<div class="row">
		                  <div class="col-md-3">
		                    <div class="form-group">
								...
								<input type="text"  class="form-control addvalidate" id="bank_code" name="bank_code" placeholder="Input text" />
							</div>
		                  </div>								  
		                  <div class="col-md-3">
		                    <div class="form-group">
		                      <label>Code de l’agence</label>
		                      <input type="text"  class="form-control addvalidate" id="agency_code" name="agency_code" value="" placeholder="Input text" />
		                    </div>
		                  </div>
		                  <div class="col-md-3">
		                    <div class="form-group">
		                      <label>Clé RIB</label>
		                      <input type="text"  class="form-control addvalidate" id="rib_key" name="rib_key" placeholder="Input text" />
		                    </div>
		                  </div>
		                  <div class="col-md-3">
		                    <div class="form-group">
		...
		<div class="modal-content">
		   ...
		   <form role="form" method="post" id="addnewcustomer">
				<div class="modal-body">   
			  	...
			  	<div class="modal-footer justify-content-center">
				  	<button type="submit" class="btn btn-primary waves-effect waves-light submitBtn">
				  	<img src="<?php echo  base_url('assets/img/select2-spinner.gif');?>" class="pull-left lodergif" style="position:relative;top:2px;left:-3px; display:none;"> Submit</button>
...
<script type="text/javascript">
		...
		submitHandler: function(form) {			
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url("PP_Credit_Scholar/add_newcustomer");?>',
...
function search(force) {
    ...
    $.ajax({
		type:'POST',
		url:'<?php echo base_url("PP_Credit_Scholar/SearchAccount");?>',
	...
	function theFunction (customerid) {
        if(confirm('Continue?') ) {
        	...
        	$.ajax({
				type:'POST',
				url:'<?php echo base_url("PP_Credit_Scholar/is_ajax_request");?>',
				...
				success:function(resp){ 
					...
					$('#callsearch').css("opacity","");											
						if(resp !=0){
							window.location.href = "<?php echo base_url('PP_Credit_Scholar/customer_details/');?>"+$.trim(resp);
						}
					}, 1500);
				}      
		     });
