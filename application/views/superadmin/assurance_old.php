                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; font-weight: bold; border-bottom: dotted 1px #000;"><span style="font-weight: normal;">BICIG <?php echo number_format($customer['account_no'],0,'',' ')." " ?: '';?></span></td>
                                                </tr>
                                                <tr>
...
">
                                ...
                                <tr>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-collapse: separate;padding-bottom: 10px;">
                                        <div style="display: flex;">
                                            ...
                                            <span style="display: block; width: 70%; border-bottom: solid 1px;"><?php  echo ($customer['dob']) ? (date("d-m-Y", strtotime($customer['dob']))) : ""; ?> </span>
                                        </div>
                                    </td>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-collapse: separate;">
                                ...
                                <tr>
                                    <td style="font-size: 14px;width: 100%;padding: 5px;text-align: left; line-height: 18px;border-collapse: separate;">
                                        <div style="display: flex;">
                                            ...
                                            <span style="display: block; width: 70%; border-bottom: solid 1px;"><?php  echo ($appformD['cdate']) ? (date("d-m-Y", strtotime($appformD['cdate']))) : ""; ?> </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
 ...
 if(($customer['cat_emp_id']=='9') || ($customer['cat_emp_id']=='10') || (strtoupper($customer['cat_employeurs']) == "PUBLIC DE CORPS") || (strtoupper($customer['cat_employeurs']) == "PUBLIC DES CORPS") || ((strtoupper($customer['cat_employeurs']) == "PUBLIC CIVIL"))){
                                            $loandate='25';
