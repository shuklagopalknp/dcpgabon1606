                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span> <input type="text" class="dob" placeholder="dd-mm-yyyy" id="dob" name="dob" value="<?php echo date('d-m-Y', strtotime($pinfo[0]['dob'])) ?>" readonly=""></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span> <input type="tel" id="main_phone" name="main_phone" class="phone_main_c" value="<?php echo $adinfo[0]['main_phone'] ?>" placeholder=""></span>
                                      <span id="main_phonevalid-msg" class="hide">✓ Valid</span>
                                      <span id="main_phoneerror-msg" class="hide"></span>
                                      </h3>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span> <input type="tel" name="alternative_phone" class="phone_alternate_c" id="alternative_phone" value="<?php echo $adinfo[0]['alternative_phone'] ?>"></span>
                                      <span id="alternative_phonevalid-msg" class="hide">✓ Valid</span>
                                      <span id="alternative_phoneerror-msg" class="hide"></span>
                                    </h3>
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span><input type="text" class="expiration_date" placeholder="dd-mm-yyyy" name="expiration_date_id" value="<?php echo date('d-m-Y', strtotime($adinfo[0]['expiration_date_id'])) ?>" readonly=""></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span> <input type="text" placeholder="dd-mm-yyyy" class="employment_date" name="employment_date" value="<?php echo date('d-m-Y', strtotime($empinfo[0]['employment_date']))?>" readonly=""></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Date De Fin de Contrat/Départ à la Retraite</label>
                                      <h3 id="tab-details"><span> <input type="text" class="edn_date_contract_cdd" placeholder="dd-mm-yyyy" name="sate_end_contract_cdd" value="<?php echo date('d-m-Y', strtotime($empinfo[0]['sate_end_contract_cdd']))?>" readonly="" onblur="set_date_end_for_CDD()"></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span> <input type="text" class="opening_date" placeholder="dd-mm-yyyy" name="opening_date" value="<?php echo date("d-m-Y", strtotime($bankinfo[0]['opening_date'])) ?>" readonly=""></span></h3>
                                    </div>
                                  </div>
 ...
 <form action="<?php echo base_url('PP_Consumer_Loans/customer_details_update')?>"  method="post"> 
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Date de naissance </label>
                <h3 id="tab-details"><span> <input type="text" class="dob" placeholder="dd-mm-yyyy" name="dob" value="<?php echo date('d-m-Y', strtotime($pinfo[0]['dob'])) ?>" readonly=
                  ""></span></h3>
              </div>
            </div>
            <div class="col-md-3">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Numéro de téléphone principal </label>
                <h3 id="tab-details"><span> <input type="tel" name="main_phone" id="phone2" class="phone_main_c" value="<?php echo $adinfo[0]['main_phone'] ?>" placeholder=""></span>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label>Second Numéro de téléphone </label>
                <h3 id="tab-details"><span><input type="text" id="phone_alt2" class="phone_alternate_c" name="alternative_phone" id="alternative_phone" value="<?php echo $adinfo[0]['alternative_phone'] ?>"></span>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Date Expiration du type d’identification </label>
                <h3 id="tab-details"><span> <input type="text" class="expiration_date" name="expiration_date_id" value="<?php echo date('d-m-Y', strtotime($adinfo[0]['expiration_date_id'])) ?>" readonly=""></span></h3>
              </div>
            </div>                  
            <div class="col-md-3">
            <div class="form-group">
        ...
        <?php } else{
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Date ouverture de compte </label>
                <h3 id="tab-details"><span> <input type="text" class="opening_date" readonly="" name="opening_date" value="<?php echo date("d-m-Y", strtotime($bankinfo[0]['opening_date'])) ?>"></span></h3>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
...
/*Additional Information Type d’identification split Section */
  ...
  /*Employment Information Catégorie Employeurs All Section */
  ...
  /*End Other Information Objet du crédit All Section */

  /*Other Information FRAIS dé DOSSIER Split Section */
