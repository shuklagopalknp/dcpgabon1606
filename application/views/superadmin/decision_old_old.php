                ...
                <tr>
                    <td>
                        <table style="width: 100%;">
                            <tbody>
                                <tr>
                                    <td style="position: relative; text-align: left;"><img src="<?php echo  base_url(); ?>assets/logo2.png" style="width: 50px;" /></td>
                                   <td style="position: relative;text-align: right;font-size: 20px;font-weight: bold;text-transform: uppercase;">Fiche d'Aide à la Décision</td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tr>
                    <td>
                        <table style="width: 100%; border-collapse: collapse; border: solid 1px;">
                            <tbody>
                                <tr>
                                    <td colspan="2" style="font-size: 12px; width: 100%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate;"></td>
                                </tr>
                                <tr>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate;">
                                ...
                                <tr>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0;">
                                        <div style="display: flex;">
                    ...
                    <td>
                        <table style="width: 100%; border-collapse: collapse; border: solid 1px;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate; vertical-align: bottom;">
                                        <div style="display: flex;">
                                    ...
                                    <td style="font-size: 12px; width: 40%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate; vertical-align: bottom;">
                                        <div style="display: flex;">
                                            <span style="display: block; width: 60%;">
                                                Administration Publique <br />
                                                Entreprise Cliente :
                                            </span>
                                            <span style="display: block; width: 15px; height: 15px; margin-right: 5px;">
                                ...
                                <tr>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0; vertical-align: bottom;">
                                        <div style="display: flex;">
                                            <span style="display: block; width: 60%;"> DATE D’ENTREE CHEZ L’EMPLOYEUR : </span>
                                            <span style="display: block; width: 35%; border-bottom: solid 1px;"><?php echo date('d-m-Y', strtotime($customer['employment_date']));?> </span>
                                        </div>
                                    </td>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate; vertical-align: bottom;">
                                        <div style="display: flex;">
                                ...
                                <tr>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0; vertical-align: bottom;">
                                        <div style="display: flex;">
                                            ...
                                            <span style="display: block; width: 35%; border-bottom: solid 1px;"><?php echo date('d-m-Y', strtotime($customer['opening_date'])); ?></span>
                                        </div>
                                    </td>
                                    <td style="font-size: 12px; width: 50%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate; vertical-align: bottom;">
                                        <div style="display: flex;">
                ...
                <tr>
                    <td>
                        <table style="width: 100%; border-collapse: collapse;">
                            <tbody style="">
                                <tr>
                                    <td style="font-size: 12px; width: 25%; border: solid 1px #000; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate; border-right: none;">
                                        <span style="font-weight: normal;">PRODUITS</span>
                                    </td>
                                    <td style="font-size: 12px; width: 25%; border: solid 1px #000; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0; border-right: none; border-left: none;">
                                    ...
                                    <td style="font-size: 12px; width: 25%; border: solid 1px #000; padding: 10px; text-align: left; line-height: 22px; border-left: none;">
                                        <span style="font-weight: normal; display: flex; align-items: center;">
                                            <span style="display: block; width: 15px; height: 15px; margin-right: 5px;">
                                                <input type="checkbox"   style="width: 15px; height: 15px; display: block; border: solid 1px #000; margin: 0; border-radius: 0px; margin: 0;" />
                                            </span>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 12px; width: 25%; border: solid 1px #000; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0; border-left: none; border-right: none;">
                                        <span style="font-weight: normal; display: flex; align-items: center;">
                                            <span style="display: block; width: 15px; height: 15px; margin-right: 5px;">
                                                <input type="checkbox"   style="width: 15px; height: 15px; display: block; border: solid 1px #000; margin: 0; border-radius: 0px; margin: 0;" />
                                            </span>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 12px; width: 25%; border: solid 1px #000; padding: 10px; text-align: left; line-height: 22px; border-spacing: 0; border: none;">
                                        <span style="font-weight: normal; display: flex; align-items: center;">
                                            <span style="display: block; width: 15px; height: 15px; margin-right: 5px;">
                                                <input type="checkbox"   style="width: 15px; height: 15px; display: block; border: solid 1px #000; margin: 0; border-radius: 0px; margin: 0;" />
                                            </span>
                ...
                <tr>
                    <td>
                        <table style="width: 100%; border-collapse: collapse; border: solid 1px;">
                            <tbody>
                                <tr>
                                    <td style="font-size: 12px; width: 100%; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate;">
                                        <div style="display: flex;">
                ...
                <tr>
                    <td>
                        <table style="width: 100%; border-collapse: collapse;">
                            <tbody>
                                <tr>
                                    <td style="font-size: 12px; padding: 10px; text-align: left; line-height: 22px; border-collapse: separate;">
