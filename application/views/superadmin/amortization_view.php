		...
		<div class="col-lg-12">
			...
			<div id="content-header" class="clearfix">
				<div class="pull-left">
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url('PP_Consumer_Loans/customer_details/'.$this->uri->segment(3));?>"><span>DÉTAILS DU CLIENT</span></a></li>
						<li class="active"><span>AMORTISSMENT SCHEDULE</span></li>
					</ol>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-3 pull-right">					
					<a href="<?php echo base_url('PP_Consumer_Loans/amortization_view_pdf/').$this->uri->segment(3);?>" class="btn btn-primary" align='middle'> <i class="fa fa-cloud-download"></i> TELECHARGER EN ODF</a>									
				</div>
