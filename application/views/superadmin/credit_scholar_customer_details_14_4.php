          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                <label>Date Expiration du type d’identification </label>
                <h3 id="tab-details"><span>
         		<input type="text" name="expiration_date_id" value="<?php echo date('d-m-Y', strtotime($adinfo[0]['expiration_date_id'])) ?>">         
               </span></h3>
              </div>
            </div> 
         <div class="col-md-3">
...
<script type="text/javascript">
  $('#frais_de_dossier').on('keyup click', function(){
   ...
   $("#frais_de_dossier").css("background-color", "#e9ffe9");
    ...
    $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_Credit_Scholar/postupdate_fees");?>',
