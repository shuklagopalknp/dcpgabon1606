                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold; font-size: 17px; border: solid 2px #000; padding: 8px;">Acte De Prêt Joint</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    <td style="width: 100%; vertical-align: top; padding-right: 10px;">
                                        <table style="width: 100%;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-size: 13px; font-weight: normal;">Nous soussignés &nbsp;: <span style="font-weight: normal;"></span></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" style="height:3px; width: 100%;"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="font-size: 13px; font-weight: normal;">
                                                        <div style="display: flex;">
                                                            ...
                                                            <span style="display: block; width: 100%; border-bottom: dashed 1px;"><?php echo ($appformD['cdate']) ? (date("d-m-Y", strtotime($appformD['cdate']))) : "";?> </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
 ...
 <li> ne pas être actuellement en état d’incapacité temporaire de travail et exercer mon activité professionnelle de façon normale et effective,</li>
   ...
   <li> exercer mon activité professionnelle de façon normale et effective</li>
    ...
    <li> ne suivre aucun traitement ou régime et ne pas être sous surveillance médicale.</li>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 65%; font-size: 13px; font-weight: normal; line-height: 19px;"></td>
                                    <td colspan="1" style="width: 35%; font-size: 13px; font-weight: normal; line-height: 19px; text-align: left;">
								 ...
								 <tr>
                               <td colspan="3" style="font-size: 13px;text-align: center;line-height: 22px;padding: 10px;">
