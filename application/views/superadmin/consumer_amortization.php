		...
		<div class="col-lg-12">
			...
			<div id="content-header" class="clearfix">
				...
				<div class="pull-left">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url('PP_Credit_Scholar/Finance_Credit_Scholar');?>">CREDIT SCHOLAIRE</a></li>

						<li class="active"><span>TABLEAU AMORTISSEMENT</span></li>
			...
			<div class="row">
				...
				<div class="col-lg-4 pull-right">
					...
					<a href="<?php echo base_url('PP_Credit_Scholar/select_customer/').$this->uri->segment(3);?>" class="btn btn-default"  align='middle'>Sélectionner Un Client</a>



					<a href="<?php echo base_url('PP_Credit_Scholar/amortization_pdf/').$this->uri->segment(3);?>" class="btn btn-primary" align='middle'> <i class="fa fa-cloud-download"></i> Telecharger En PDF</a>									
