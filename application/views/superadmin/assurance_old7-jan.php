                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="font-size: 14px; font-weight: bold; border-bottom: dotted 1px #000;"><span style="font-weight: normal;">BICIG </span></td>
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-spacing: 0;">
                                        <div style="display: flex;">
                                            ...
                                            <span style="display: block; width: 60%; border-bottom: solid 1px;"><?php echo ucfirst($customer['resides_address'])." " ?: '-';?> </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-collapse: separate;">
                                        <div style="display: flex;align-items: center;">
                                            ...
                                            <span style="display: block;width: 17%;border: solid 1px;margin-left: 10px;height: 26px;"> </span>
                                        </div>
                                    </td>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-spacing: 0;">
                                ...
                                <tr>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-collapse: separate;">
                                        <div style="display: flex;">
                                            ...
                                            <span style="display: block;width: 17%;border: solid 1px; height: 26px;"> </span>
                                        </div>
                                    </td>
                                    <td style="font-size: 14px;width: 50%;padding: 5px;text-align: left; line-height: 18px;border-spacing: 0;">
                                        <div style="display: flex;">
