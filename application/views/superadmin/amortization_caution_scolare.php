			...
			<div class="main-box-body clearfix">
				<div class="row">
					<div class="col-lg-5 pull-right">
						<a href="<?php echo base_url('PP_Caution_Scolare_Loans/select_customer/').$this->uri->segment(3);?>" class="btn btn-default"  align='middle'>Sélectionner Un Client</a>
						<a href="<?php echo base_url('PP_Caution_Scolare_Loans/download_temp_amortizationpdf/').$this->uri->segment(3);?>" class="btn btn-primary" align='middle'> <i class="fa fa-cloud-download"></i> Telecharger En PDF</a>
					</div>
				</div>
