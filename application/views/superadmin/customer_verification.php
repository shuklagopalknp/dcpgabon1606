					...
					<div id="content-header" class="clearfix">
						<div class="pull-left">
							<ol class="breadcrumb">
								...
								<li class="active"><span>Customer Verification</span></li>
							</ol>
						</div>
					</div>
													...
													<tbody id="callsearch">
														...
														//print_r($key);
														 ?>
														    ...
														    <td><a href="#" class="btn btn-primary" onclick="return theFunction(<?php echo $key['cid'];?>);"/>
															SELECT</a></td>
														</tr>
														<?php } ?>
													</tbody>
		...
		success:function(resp){ 
             ...
             setTimeout(function() {
              $("#callsearch").html(resp).css("opacity","");
				...
				// window.location.href = "<?php //echo base_url('PP_Consumer_Loans/customer_verification/'); ?>"+resp+"";
			}, 500);	
          }                
      });
