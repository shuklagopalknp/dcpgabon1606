			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div id="content-header" class="clearfix">
						...
						<h1>
							<?php if($record[0]->type=="Supper Admin")
							{
						...
						<div class="col-lg-3 col-md-4 col-sm-4">
							<div class="main-box clearfix">
								<header class="main-box-header clearfix">
									<h2><?php echo $record[0]->first_name;?></h2>
								</header>
								<div class="main-box-body clearfix">
									<div class="profile-status">
										<i class="fa fa-circle"></i> Online
									</div>
									<?php if(!empty($record[0]->avatar)){
										echo "<img src=\"".base_url('assets/user-profile-img/'.$record[0]->avatar)."\" alt=\"profile\"  title=\"".ucfirst($record[0]->user_name)."\"  class=\"profile-img img-responsive center-block\" />";
									 } else {
									 	echo "<img src=\"".base_url('assets/img/user.png')."\" alt=\"profile\" title=\"".ucfirst($record[0]->user_name)."\" class=\"profile-img img-responsive center-block\"/>";
									};
									?>

<div class="profile-label">

<span class="label label-danger"><?php if($record[0]->type=="Supper Admin")
							{
								echo "Account Manager";
							}else if($record[0]->type=="Sub Admin")
							{
...
<span><?php if($record[0]->type=="Supper Admin")
							{
								echo "Account Manager";
							}else if($record[0]->type=="Sub Admin")
							{
...
<!-- //Jan 2012 -->
Member since: <?php echo date('M Y', strtotime($record[0]->created_at));?>
...
<li><i class="fa-li fa fa-truck"></i>Avis Favorable	: <span>1</span></li>

<li><i class="fa-li fa fa-comment"></i>Posts Loan: <span>7</span></li>

<li><i class="fa-li fa fa-tasks"></i>Tasks done: <span>0</span></li>
...
<img src="<?php echo base_url('assets/img/samples/robert-300.jpg');?>" alt=""/>
...
Jennifer Lawrence posted a comment in <a href="#">Avengers Initiative</a> project.
...
Jennifer Lawrence changed order status from <span class="label label-primary">Pending</span>
...
Jennifer Lawrence posted a comment in <a href="#">Lost in Translation opening scene</a> discussion.
...
Jennifer Lawrence changed order status from <span class="label label-warning">On Hold</span>
...
<!-- Mirrored from www.ravijaiswal.com/Afro-v.1.1/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Feb 2017 08:18:17 GMT -->
