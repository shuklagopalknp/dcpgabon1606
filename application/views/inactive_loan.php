			...
			<div id="content-header" class="clearfix">
				<div class="pull-left">
					<ol class="breadcrumb">
						...
						<li class="active"><span>INACTIVE LOAN</span></li>
						<li><span><?php echo $page_title;?> </span></a></li>
											...
											<tr id="rowid<?php echo $ld['loan_id'];?>">
											  ...
											  //  print_r($app_status);
											 	...
											 	<td class="sorting_1">
													...
													<a href="<?php echo base_url($pagelink.'/customer_details/').$ld['loan_id']."/view";?>" class="table-link">
														<span class="fa-stack">
