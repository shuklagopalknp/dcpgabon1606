					...
					<div class="main-box">	
						...
						<div class="main-box-body clearfix">
							...
							<div class="col-md-12">
								...
								<form id="docForm" action="<?php echo base_url('Settings/customer_product_documents');?>"  method="post" class="form-horizontal" role="form" >

									
									<fieldset>
										<legend>Customer Tabs</legend>	
									<div class="form-group">
										...
										<div class="col-md-3">
											<select name="product_type" class="form-control product_type_c">
												...
												<option value="credit_conso" <?php  if($_POST) echo ($_POST['product_type'] == "credit_conso") ? "selected" : "";  ?> >PP FETES A LA CARTE</option>
												<option value="credit_scolair" <?php  if($_POST) echo ($_POST['product_type'] == "credit_scolair") ? "selected" : "" ?>>PP CONGES A LA CARTE</option>
												<option value="credit_confort" <?php  if($_POST) echo ($_POST['product_type'] == "credit_confort") ? "selected" : "" ?>>PP CREDIT CONFORT</option>
							...
							<form action ="<?php echo base_url('Settings/save_customer_docs');?>" method="POST">
							<div class="row"  style="margin-bottom: 2%;">
							<div class="col-md-12">
