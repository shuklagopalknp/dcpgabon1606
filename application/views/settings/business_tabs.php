					...
					<div class="main-box">	
						...
						<div class="main-box-body clearfix">
							...
							<form id="tabForm" action="#"  method="post" class="form-horizontal" role="form" >
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<select name="product_type" class="form-control product_type_c">
											...
											<option value="gage_espece">PP Gage Espece</option>
											<option value="commune">PP Commune</option>
											<option value="depassment">PP Depassment</option>
											<option value="escompte">PP Escompte</option>
										</select>
									</div>
								</div>
								...
								<?php 
								$count = 1;
								foreach($business_tabs as $key=>$row) { ?>
								...
								<tr>
									...
									<td>
										<span class="show_c badge badge-info"><?=$count?></span>
										<input type="hidden" class="input_order" name="order[<?php echo $key;?>]" value="<?=$count?>">
									</td>
								</tr>	
...
<script>
	...
	$(".product_type_c").change(function()
	{
		...
		if($(this).val)
		{
			$.ajax({
						type:"POST",
						url:"<?php echo base_url('Settings/get_details_product_type');?>",
