    ...
    <div class="modal-content">
		...
		<form role="form" method="post" id="userForm" enctype="multipart/form-data" accept-charset="utf-8">
	      	<div class="modal-body">
	        	...
	        	<!-- <div class="form-group">        		
	        		<label for="inputError" class="control-label" >Entités</label>
	        		<input type="text" class="form-control" id="entities" name="entities" value="" placeholder="Enter Entités" autocomplete="off" />
	        	</div> -->
    ...
    <div class="modal-content">
		...
		<form role="form" method="post" id="userEditForm" enctype="multipart/form-data" accept-charset="utf-8">
	      	<div class="modal-body">
	        	...
	        	<!-- <div class="form-group">        		
	        		<label for="inputError" class="control-label" >Entités</label>
	        		<input type="text" class="form-control" id="edit_entities" name="edit_entities" value="" placeholder="Enter Entités" autocomplete="off" />
	        	</div> -->
