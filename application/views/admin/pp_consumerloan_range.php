					...
					<div id="content-header" class="clearfix">
						<div class="pull-left">
							<ol class="breadcrumb">
								...
								<li class="active"><span>PP Consumer Loan Range</span></li>
							</ol>
						</div>
					</div>
				</div>
			</div>
			<!-- start from createtion -->
			<div class="row">
				<div class="col-lg-12">
					<div class="main-box">
										...
										<div class="form-group col-md-12">
		                                    ...
		                                    <div class="col-sm-12 col-md-12">
												<div class="form-group row ">
													<label for="exampleInputEmail2" class="control-label col-md-3">&nbsp;</label>
													<div class="input-group">
														<input type="hidden" class="form-control" name="loan_type" value="<?php echo trim($range[0]['lid']) ?: '1';?>">
														<input type="hidden" class="form-control" name="editid" value="<?php echo trim($range[0]['id']) ?: '0';?>">
...
<script type="text/javascript">
	$('#updaterange').click(function(){
		//alert("dfdf");
		$("#loanrange_creditscholar").css("opacity","0.5");	
