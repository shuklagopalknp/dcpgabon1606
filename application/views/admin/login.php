								...
								<div class="row">									
									<div class="col-xs-12">
										...
										<div id="login-box-inner">
											<?php echo  form_open('Auth/logged__in',array('id'=>'signinForm','class'=>'form-horizontal','method'=>'post')); ?>
											
												<div class="form-group">
													<div class="input-group">
														<span class="input-group-addon"><i class="fa fa-user"></i></span>
														<input type="text" class="form-control" name="u_email" id="u_email" value="" placeholder="eg.: admin@example.com">
													</div>
												</div>
												<div class="form-group">
													<div class="input-group">
												...
												<div id="remember-me-wrapper">
													...
													<a href="<?php echo base_url('auth/forgetpassword');?>" id="login-forget-link" class="col-xs-6">Forgot password?</a>
													</div>
												</div>
												<div class="row">
													<div class="col-xs-12">
