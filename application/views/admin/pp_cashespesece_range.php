					...
					<div id="content-header" class="clearfix">
						<div class="pull-left">
							<ol class="breadcrumb">
								...
								<li class="active"><span>PP Cash  Espesece Loan Range</span></li>								
							</ol>
						</div>
					</div>
...
<label for="exampleInputEmail2" class="control-label col-md-3">Amount Required: </label>
...
<div class="form-group row" id="form_row">
<label for="exampleInputEmail2" class="control-label col-md-3">Duration: </label>
...
<input type="checkbox" id="checkbox-inl-1" checked="checked">
