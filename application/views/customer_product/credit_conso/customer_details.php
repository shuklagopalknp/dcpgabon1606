                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:0px;margin-bottom:50px; margin-top:20px;">
                  <div class="main-box" style="padding: 15px 0px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="text-align:center">
                       <a href="<?php echo base_url('PP_Consumer_Loans/amortization_loan/').$loan_details['loan_id_temp'].'/1/view/'.$loan_details['loan_id'];?>" class="btn btn-default loan-back"  style="margin-top:25px;">Amortissement</a>
                      </div>
              ...
              <form id="fraisDeDossierForm" method="post">
                ...
                <div class="col-md-3"> 
                  ...
                  <label>Prime d'Assurance/Assurance Personnelle</label>
                    ...
                    ?>
                       <input type="text" class="form-control" id="frais_de_assurance" name="frais_de_assurance"  value="<?php echo $loan_details['frais_de_assurance'] ? $loan_details['frais_de_assurance'] : "0"  ;?>" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                      echo "readonly" ; }?>>
                    <?php } else {
...
<form id="addnewcustomer" action=''  method="post"> 
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                     ...
                     <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                       echo $customer->title ;?>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                     <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                       echo isset($customer->dob) ? date('d-m-Y', strtotime($customer->dob)):"" ;?>

                     <?php } else {?>
                    <input type="text" class="dobdt form-control" placeholder="dd-mm-yyyy"   name="dob" value="<?php echo isset($customer->dob) ? date('d-m-Y', strtotime($customer->dob)):""; ?>" readonly >
                  <?php } ?>
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                    <?php 
                     ...
                     if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
             ...
             <!--  <div class="col-md-3" hi>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                     <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                         //echo $customer->expiration_date_id;
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group" style="margin-bottom:5px;">
                  ...
                  <div id="tab-details">
                  <?php if($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission'))){ if($loan_details['final_status']!="Disbursement"){ ?>
              ...
              <div class="col-md-3">
                 ...
                 <div class="form-group" style="margin-bottom:5px;">
                    ...
                    <label>Type de Contrat </label>
                     <div id="tab-details">
                    <?php if($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission'))  && $loan_details['final_status']!="Disbursement"){ ?>
            ...
            <div class="row">
              ...
              $Typeid = array(
               ...
               <div id="tab-details">
          <?php
          if($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status']!="Disbursement"){ ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div id="tab-details"> 
                     ...
                     <input type="text"  class="form-control addvalidate" id="prochaineRevision" name="prochaineRevision" placeholder="DD-MM-YYYY" value="<?php echo !empty($customer->prochaineRevision) ? date('d-m-Y', strtotime($customer->prochaineRevision)):""; ?>" readonly />
                   <?php } ?>
                      </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                   ...
                   <input type="text" class="form-control" name="risk_level_date" value="<?php echo !empty($customer->risk_level_date) ? date('d-m-Y', strtotime($customer->risk_level_date)) :""; ?>" readonly readonly >
                 <?php } ?>
                 </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                 ...
                 <?php } ?>
                   ...
                   <input type="text"  class="form-control addvalidate" id="authDate" name="authDate" placeholder="DD-MM-YYYY" value="<?php echo !empty($customer->authDate) ? date('d-m-Y', strtotime($customer->authDate)) : ""; ?>" readonly readonly />
                 <?php } ?>
                    </div>
        ...
        <div class="tab-pane fade" id="tab-3">
          ...
          <div class="row">
            ...
            <input type="hidden" id="getcid"  name="getcid" value="">
              ...
              <a href="<?php echo base_url('Customer_Product/download_documents/credit_conso/system_docs/').$loan_details['loan_id']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Télécharger</a>
          ...
          <div class="row">
            ...
            <?php } ?>
              ...
              <a href="<?php echo base_url('Customer_Product/download_documents/credit_conso/checklist_docs/').$loan_details['loan_id']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Télécharger</a>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <label class="switch">
                                                  ...
                                                  <?php if($documents['checklist_status'][$key] == "1") echo "checked";?>  
                                                   <?php if ($param == "view" || $param == "view" || !in_array('4_2', $this->session->userdata('portal_permission'))){
                                                      echo "disabled" ; }?>  >
                                            ...
                                            <div class="col-lg-6">
                                              <div class="form-group">
                                                 ...
                                                 <label class="switch">
                                                  ...
                                                  <?php if($documents['risk_status'][$key] == "1") echo "checked";?>  <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission'))){
                                                      echo "disabled" ; }?> >
                                                  <span class="slider round "></span>
                                                </label>
									...
									<table class="table table-condensed table-hover">
										...
										<tbody>
											...
											<?php if($risk_analysis['amount_a_s1'] != "" || $risk_analysis['amount_a_s2'] != ""){
													...
													foreach($a_s1 as $key=>$s1){
														if($key == "0")
														{
															...
															<tr class="analyserow_a">
																...
																<td>
																	<input type="number" value="<?php echo $s1?>" name="amount_a1[]" class="form-control amount_a1 fmt_number" min="0" required <?php  if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
																</td>
																<td>
																	<input type="number" value="<?php echo $a_s2[$key]?>" name="amount_a2[]" class="form-control amount_a2 fmt_number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
																</td>
																<td>
																    <?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_a">+</button><?php } ?></td>
														</tr>
												...
												?>
											<tr class="tr_a<?php echo $i;?>"> <td> </td><td><input type="number" value="<?php echo $s1?>" name="amount_a1[]" class="form-control amount_a1 fmt_number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()"  <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
											<td><input type="number" value="<?php echo $a_s2[$key]?>" name="amount_a2[]" class="form-control amount_a2 fmt_number" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
											<td>
											    <?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?>
											...
											$i++;
												...
												<td>
												 ...
												 <input type="number" value="" name="amount_a1[]" class="form-control amount_a1 fmt_number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
												
												</td>
												<td>
												 <input type="number" value="" name="amount_a2[]" class="form-control amount_a2 fmt_number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
													
												</td>
												<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_a">+</button><?php } ?></td>
											</tr>
											<?php }
											...
											<tr class="analyserow_b">
												...
												<td>
													<input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 fmt_number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
												</td>
												<td>
													<input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 fmt_number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
													
												</td>
												 <td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_b">+</button><?php } ?></td>
											</tr>

												<?php } else { ?>
													<tr class="tr_b<?php echo $j?>"> <td> </td>
													<td><input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 fmt_number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
													<td><input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 fmt_number" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
													<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary" onclick="removerow_b('<?php echo $j?>');">-</button><?php } ?></td></tr>
												<?php } 
												 $j++;
												} } else {?>
													<tr class="analyserow_b">
														<td> B -  Échéances Mensuelles  BICIG </td>
														<td>
															<input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
														</td>
														<td>
															<input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
												...
												//  echo $risk_analysis['amount_c_s1'];
													...
													?>
														<tr class="analyserow_c">
															...
															<td>                          
																<input type="number" value="<?php echo $cs1;?>" name="amount_c1[]" class="form-control amount_c1 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
															</td>
															<td>
																<input type="number" value="<?php echo $c_s2[$key];?>" name="amount_c2[]" class="form-control amount_c2 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
															</td>
															 <td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_c">+</button><?php } ?></td>
														</tr>

													<?php } else {?>
														<tr class="tr_c<?php echo $k;?>"> <td> </td>
														<td><input type="number" value="<?php echo $cs1?>" name="amount_c1[]" class="form-control amount_c1 number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
														<td><input type="number" value="<?php echo $c_s2[$key]?>" name="amount_c2[]" class="form-control amount_c2" min="0" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" required <?php if ( $param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
														<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_c('<?php echo $k; ?>');">-</button><?php } ?></td></tr>
													<?php } } }else { ?>

														<tr class="analyserow_c">
															<td> C - Echéances Mensuelles Autres </td>
															<td>                          
																<input type="number" value="" name="amount_c1[]" class="form-control amount_c1 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
															</td>
															<td>
																<input type="number" value="" name="amount_c2[]" class="form-control amount_c2 number" min="0" required <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
															</td>
															 <td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_c">+</button><?php } ?></td>
														</tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    ...
                                                    <div class="alert alert-success loan_condition" <?php if($risk_analysis['updated_loanamount']){ ?> style="display:block" <?php } else {?> style="display:none" <?php } ?>>
                                                        <?php  if($risk_analysis['updated_loanamount']) echo "Loan Amount is updated according to Droit de credit maximum";?>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <tbody>
                      <form id="FormAnalyseNew2" method="post">
							...
							<tr>
								...
								<td>
									<input type="number" value="" name="solde_du_cav" class="form-control analysis_cal2 solde_du_cav_c" min="0" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?>/>
									
									
								</td>
								<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?> 
							...
							<tr class="tr_cav<?php echo $r_count;?>">
								...
								<td>
									<input type="number"  value="<?php echo $rd->value;?>" name="solde_du_cav" class="form-control analysis_cal2 solde_du_cav_c" min="0" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr class="analysenew2">
								...
								<td>
										...
										<input type="number"  value="<?php echo $risk_analysis['solde_du_csfbm'];?>" name="solde_du_csfbm" class="form-control analysis_cal2 solde_du_csfbm_c" min="0" <?php if ($param == "view" || $param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr>
								...
								<td>
									<input type="number" value="" name="solde_encours" class="form-control analysis_cal2 solde_encours_c" min="0" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr class="tr_en<?php echo $r_count1;?>">
								...
								<td>
									<input type="number" value="<?php echo $rd1->value ; ?>" name="solde_encours" class="form-control analysis_cal2 solde_encours_c" min="0" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
        				...
        				<table class="table table-condensed table-hover">
        					...
        					<tbody>                                                         
        						...
        						<form id="coefficient_form1" method="post"> 
        							...
        							<tr class="tr_coff10">
        								<td><input type="number" id="st1_10" class="form-control salary_t1 number" name="salary[]" min="0" onblur="calculateRow('0');" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="mt1_10" class="form-control mois_t1 number" name="mois[]" min="0" onblur="calculateRow('0');" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="at1_10" class="form-control ans_t1 number" name="ans[]" min="0" onblur="calculateRow('0');" readonly ></td>

        								<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?> <button type="button" class="btn btn-primary addrow_coff1">+</button><?php } ?></td>
        							</tr>
        							<?php } else { 
        							...
        							<tr class="tr_coff1<?php echo $l;?>">
        								<td><input type="number" id="st1_1<?php echo $l;?>" class="form-control salary_t1 number" name="salary[]" min="0" onblur="calculateRow('<?php echo $l;?>');" value="<?php echo $value->salary;?>" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="mt1_1<?php echo $l;?>" class="form-control mois_t1 number" name="mois[]" min="0" onblur="calculateRow('<?php echo $l;?>');" value="<?php echo $value->mois;?>" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								...
        								<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff1">+</button><?php } ?></td>
        								<?php } else {?>
        								<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_coff1('<?php echo $l;?>')">-</button><?php } ?></td>
        								<?php } ?>
        							</tr>
						...
						<div class="table-responsive">
							<table class="table table-condensed table-hover">
								...
								<tbody>                                                         
									...
									<tr>
										<td><input type="number" id="rt2_20" class="form-control remboursement_t2 number" name="remboursement[]" min="0" value="<?php echo $loan_details['pmnt'];?>" onblur="calculateRemRow('0');" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php }else { ?> readonly <?php }?> ></td>
										<td><input type="number" id="mt2_20" class="form-control mois_t2 number" name="mois1[]" min="0" value="<?php echo $loan_details['loan_term'];?>" onblur="calculateRemRow('0');" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php }else { ?> readonly <?php }?> ></td>
										...
										<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff2">+</button><?php } ?></td>
									</tr>
									 <?php } else {
									 	$coeff_record1 = json_decode($risk_analysis['coefficient_rembursement']);
										//	print_r($coeff_record1);
											$m = 1;
											foreach ($coeff_record1 as $key => $value1) {
									 	?>
									 	<tr class="tr_coff2<?php echo $m;?>">
										<td><input type="number" id="rt2_2<?php echo $m;?>" class="form-control remboursement_t2 number" name="remboursement[]" min="0" onblur="calculateRemRow('<?php echo $m;?>');" value="<?php echo $value1->rem;?>" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $key == "0" || $loan_details['final_status'] == "Disbursement" ){?> readonly <?php } ?> ></td>
										<td><input type="number" id="mt2_2<?php echo $m;?>" class="form-control mois_t2 number" name="mois1[]" min="0" onblur="calculateRemRow('<?php echo $m;?>');" value="<?php echo $value1->mois;?>" <?php if ($param == "view" || !in_array('4_2', $this->session->userdata('portal_permission')) || $key == "0"  || $loan_details['final_status'] == "Disbursement"){?> readonly <?php }?> ></td>
										...
										<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff2">+</button><?php } ?></td>
										<?php } else {?>
										<td><?php if ($param == "edit" && in_array('4_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_coff2('<?php echo $m;?>')">-</button><?php } ?></td>
										<?php } ?>
									</tr>
									 <?php $m++ ;} }?>
									<tr class="coff2">
						...
						<tbody>                                                         
							...
							<tr>
								...
								<div>
									...
									<input type="number" id="" value="<?php echo $diff->m;?>" name="" class="form-control" min="0" <?php if($diff->m <= 6 && $diff->y==0){?> style="color:red" <?php } else {?> style="color:green"  <?php } ?>disabled />
								...
								<div>
										...
										<input type="number" id="" value="<?php echo $diff->y ;//number_format($month_val/12,2);?>" name="" class="form-control" min="0" disabled />
    ...
    <?php }} else if($this->session->userdata('role') ==  "9") {
      if($param == "edit" && in_array('4_6', $this->session->userdata('portal_permission'))) {
      ?>
          ...
          <div class="tab-pane fade" id="tab-7">
            ...
            <form id="loanEditForm" action="#"  method="post">
              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" value="Prêt FAC" readonly disabled>
              ...
              <select class="form-control" id="loan_amt_drop" onchange='CheckColors(this.value);' required <?php if ($param == "view"|| !in_array('4_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
               ...
               <select class="form-control" id="loan_object_drop" onchange='add_object(this.value);' required <?php if ($param == "view"|| !in_array('4_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
                
                <option value="fetes a la carte" <?php if($loan_details['loan_object'] == "fetes a la carte") echo "selected";?> >Fetes a la carte</option>
              ...
              <div class="row">
                ...
                <select class="form-control numberformat" name="loan_term" id="loan_term" required <?php if ($param == "view"|| !in_array('4_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
   ...
   function calculateSum(){
    ...
    function calculateSumT1(){
     ...
     var total_ana = $("#total_analyse_cal").val();
        ...
        //   if(parseInt(total_ana) > 0)
        //   {
        //       if(parseInt(total_ana) >5000001)
        //       {
        //           $(".analysecumul-msg").html("Dossier Hors Pouvoir d'engagement agence").addClass("alert alert-success");
        //           //$(this).val('');
        //       }
        //       else{
        //           $(".analysecumul-msg").html("").removeClass("alert alert-success");
        //       }
        //   }
        //   else
        //   {
        //       var str = document.getElementById("total_analyse_cal").value; 
        //       var res = str.replace("-", "");
        //         console.log(parseInt(res));
        //       if(parseInt(res)>5000001)
        //       {
	 ...
	 // var amount_a1 = $('form.amount_a1').serialize();
        ...
        if(new_loanamount){
            $(".loan_condition").html("Loan Amount is updating according to Droit de credit maximum");
        }
        else{
            $(".loan_condition").html("");
        }
	...
	function save_salary_data(){
		...
		$.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_FETES_A_LA_CARTE/riskAnalysis_coefficient_salary");?>',
	...
	setTimeout(function(){
        ...
        $.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_FETES_A_LA_CARTE/riskAnalysis_coefficient_remboursement");?>',
	...
	function save_total_engagement_riskform(){
		...
		setTimeout(function(){
			$.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_FETES_A_LA_CARTE/riskanalysis_total_engagements");?>',
				...
				success: function(response){
		            ...
		            if(response=="success"){                                    
		              $('.analysecumul-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully And Workflow Initiated').addClass('alert alert-success fade in').fadeOut(5000);  
		              ...
		              $('.analysecumul-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully And Workflow Reinitiated ').addClass('alert alert-success fade in').fadeOut(5000);  
		                }
		            else if(response == "no_workflow_change"){
		              $('.analysecumul-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully').addClass('alert alert-success fade in').fadeOut(5000);  
		                }
		            else{
  ...
  {   
   ...
   $("#smsHistoryForm").validate({
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_history_interaction/credit_conso/sms/").$loan_details['loan_id'];?>',
          data:$(formdata).serialize(),
          beforeSend: function(){
   ...
   $("#interviewHistoryForm").validate({
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_history_interaction/credit_conso/interview_telephone/").$loan_details['loan_id'];?>',
          data:$(formdata).serialize(),
          beforeSend: function(){
...
//$('#loanEditFormdetais').submit(function(){
 ...
 $(document).on("keyup click", ".qty223", function() {
    ...
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_FETES_A_LA_CARTE/riskanalysis_current_monthly_credit2");?>',
        data:$.trim(serializedFormR),
        //contentType: false,
        cache: false,
        //processData: false,
   ...
   $(document).on("keyup click", ".qty2233", function() {
    ...
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_FETES_A_LA_CARTE/riskanalysis_current_monthly_credit3");?>',
        data:$.trim(serializedFormR),
        //contentType: false,
        cache: false,
        //processData: false,
