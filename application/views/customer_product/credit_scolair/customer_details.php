    ...
    <div class="row">
      ...
      <div class="col-lg-12">
                  ...
                  <div class="bg-header">
                    <div class="well well-sm well-primary" style="background-color:transparent !important">
                                  <div class="row well_row">
                                    ...
                                    <div class="col-xs-2"><?php echo $loan_details['department'];?></div>
                                  </div>
                                  <div class="row well_row">
                                    ...
                                    <div class="col-xs-2 no-padding">PP CONGES A LA CARTE</div>
                  ...
                  <div class="main-box" style="padding: 15px 0px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="text-align:center">
                        ...
                        if($newDec['decision']=='Abandonner' || $newDec['decision']=='Annuler' || $newDec['decision']=='Disbursement'){
                      ...
                      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="text-align:center">
                       <a href="<?php echo base_url('PP_Consumer_Loans/amortization_loan/').$loan_details['loan_id_temp'].'/2/view/'.$loan_details['loan_id'];?>" class="btn btn-default loan-back"  style="margin-top:25px;">Amortissement</a>
                      </div>
        ...
        <div class="tab-pane fade" id="tab-2">
              ...
              <form id="fraisDeDossierForm" method="post">
                ...
                <div class="col-md-3">
                  ...
                  <label>Frais de dossier HT</label>
                    ...
                    ?>
                  <input type="text" class="form-control" id="frais_de_doss" name="frais_de_doss" autocomplete="off" readonly value="<?php echo number_format($ht,0,',',' ');?>" required min="0"  <?php if (!in_array('6_2', $this->session->userdata('portal_permission'))){
                      echo "readonly" ; }?> >
                    </div>
                  </div>
                ...
                <div class="col-md-3">
                  ...
                  <label>Frais de Dossier TTC</label>
                    ...
                    ?>
                  <input type="text" class="form-control" id="frais_de_doss" name="frais_de_doss" autocomplete="off" readonly value="<?php echo number_format($tcc,0,',',' ');?>" required min="0"  <?php if (!in_array('6_2', $this->session->userdata('portal_permission'))){
                      echo "readonly" ; }?> >
                    </div>
                  </div>
                ...
                <div class="col-md-3"> 
                  ...
                  <label>Prime d'Assurance/Assurance Personnelle</label>
                    ...
                    ?>
                       <input type="text" class="form-control" id="frais_de_assurance" name="frais_de_assurance"  value="<?php echo $loan_details['frais_de_assurance'] ? $loan_details['frais_de_assurance'] : "0"  ;?>" <?php if (!in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                      echo "readonly" ; }?>>
                    <?php } else { 
          ...
          $teg=$am->tegcal($loan_details['npmts'],$loan_details['loan_amt'],$loan_details['pmnt'],$rt,$loan_details['frais_de_dossier'],$age,$assurance);
        // print_r($teg);
            ...
            <div class="row">
               ...
               <div class="col-md-3"> 
                  ...
                  <label>Barème de l'Assurance</label>
                    <div class="input-group">
                    <span class="input-group-addon"></span>
              ...
              <div class="col-md-12">
                ...
                <?php if($age > 60) {?>
                  ...
                  <input type="hidden" name="application_id" id="application_id" value="<?php echo $loan_details['loan_id']?>">
                   <input type="hidden" name="product" id="product_type" value="credit_scolair">

                   <?php if (in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?>
...
<form id="addnewcustomer" action=''  method="post"> 
            ...
            <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                     ...
                     <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                       echo $customer->title ;?>
                ...
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                    <?php 
                     ...
                     if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <?php
                    ...
                    <div id="tab-details">
                   <?php  if($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status']!="Disbursement"){ ?>
               ...
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                   ...
                   <input type="text" class="form-control" name="state_of_issue" value="<?php echo $customer->state_of_issue ?>" > 
                    <?php }?>
                 </div>
                </div>
              </div>
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details">  
                    ...
                    <input type="phone" name="main_phone" id="main_phone" class="phone_main_c  form-control" value="<?php echo $customer->main_phone ?>"  placeholder=""  onkeypress="return istelNumber(event)">
             ...
             <!--  <div class="col-md-3" hi>
              ...
              <div class="form-group">
                ...
                <div id="tab-details"> 
                   <?php if ($param == "view" || $param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group" style="margin-bottom:5px;">
                  ...
                  <div id="tab-details">
                  <?php if($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission'))){ if($loan_details['final_status']!="Disbursement"){ ?>
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                    <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                       echo !empty($customer->how_he_is_been_with_current_employer) ? date('d-m-Y', strtotime($customer->how_he_is_been_with_current_employer)) :"";
                        } else { ?> 
            ...
            <div class="row">
              ...
              $Typeid = array(
               ...
               <div id="tab-details">
          <?php
          if($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status']!="Disbursement"){ ?>
                ...
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                    <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){
                     ...
                     <input type="text" class="opening_dt form-control"  name="opening_date" value="<?php echo date("d-m-Y", strtotime($customer->opening_date)) ?>" readonly >
                   <?php } ?>
                   </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                    ...
                    <input type="text" name="account_number" class="form-control" value="<?php echo $customer->account_no ?>"  onkeypress="return isNumber();" readonly >
                      <?php } ?>
                  </div>
                </div>
              </div>
               ...
               <div class="col-md-2">
                <div class="form-group">
                  ...
                  <div id="tab-details"> 
                   ...
                   <input type="text" name="rib4" class="form-control" value="<?php echo $customer->rib4 ?>" readonly readonly >
                 <?php } ?>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <div id="tab-details"> 
                     ...
                     <input type="text"  class="form-control addvalidate" id="prochaineRevision" name="prochaineRevision" placeholder="DD-MM-YYYY" value="<?php echo date('d-m-Y', strtotime($customer->prochaineRevision)); ?>" readonly />
                   <?php } ?>
                      </div>
       ...
       <!--  </div> -->
        ...
        <div class="tab-pane fade" id="tab-3">
          ...
          <div class="row">
            ...
            <input type="hidden" id="getcid"  name="getcid" value="">
              ...
              <a href="<?php echo base_url('Customer_Product/download_documents/credit_scolair/system_docs/').$loan_details['loan_id']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Télécharger </a>
          ...
          <div class="row">
            ...
            <?php } ?>
              ...
              <a href="<?php echo base_url('Customer_Product/download_documents/credit_scolair/checklist_docs/').$loan_details['loan_id']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Télécharger </a>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <label class="switch">
                                                  ...
                                                  <?php if($documents['checklist_status'][$key] == "1") echo "checked";?>  
                                                   <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission'))){
                                                      echo "disabled" ; }?>  >
        ...
        <div class="tab-pane fade" id="tab-4">
            <div class="row">
                <div class="col-lg-12 tracking_section">
        ...
        <div class="tab-pane fade" id="tab-5">
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <!--  <a href="<?php echo base_url('Customer_Product/download_documents/credit_scolair/risk_analysis_docs/').$loan_details['loan_id']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Download</a>-->
                                            ...
                                            <div class="col-lg-6">
                                              <div class="form-group">
                                                 ...
                                                 <label class="switch">
                                                  ...
                                                  <?php if($documents['risk_status'][$key] == "1") echo "checked";?>  <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission'))){
                                                      echo "disabled" ; }?> >
                                                  <span class="slider round "></span>
                                                </label>
    ...
    <div class="row salary_section">
            <div class="col-md-12">
              <h3 id="tab-title" style="margin-top:2%;"><span> Calcul Salaire Residuel</span></h3>
              <?php 
             // print_r($loan_details);
              ?>
							...
							<table class="table table-condensed table-hover">
								...
								<tbody>
									...
									<?php if($risk_analysis['amount_a_s1'] != "" || $risk_analysis['amount_a_s2'] != ""){
											...
											foreach($a_s1 as $key=>$s1){
												if($key == "0")
												{
													...
													<tr class="analyserow_a">
														...
														<td>
															<input type="number" value="<?php echo $s1?>" name="amount_a1[]" class="form-control amount_a1 fmt_number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php  if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
														</td>
														<td>
															<input type="number" value="<?php echo $a_s2[$key]?>" name="amount_a2[]" class="form-control amount_a2 fmt_number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()"  min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
														</td>
														<td>
														    <?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_a" onclick="addrow_a()">+</button><?php } ?></td>
												</tr>
										...
										?>
									<tr class="tr_a<?php echo $i;?>"> <td> </td><td><input type="number" value="<?php echo $s1?>" name="amount_a1[]" class="form-control amount_a1 fmt_number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
									<td><input type="number" value="<?php echo $a_s2[$key]?>" name="amount_a2[]" class="form-control amount_a2 fmt_number" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
									<td>
									    <?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?>
									...
									$i++;
										...
										<td>
										 ...
										 <input type="number" value="" name="amount_a1[]" class="form-control amount_a1 fmt_number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
										
										</td>
										<td>
										 <input type="number" value="" name="amount_a2[]" class="form-control amount_a2 fmt_number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
											
										</td>
										<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_a" onclick="addrow_a()">+</button><?php } ?></td>
									</tr>
									<?php }
									...
									<tr class="analyserow_b">
										...
										<td>
											<input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 fmt_number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
										</td>
										<td>
											<input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 fmt_number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
											
										</td>
										 <td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_b"  onclick="addrow_b()">+</button><?php } ?></td>
									</tr>

										<?php } else { ?>
											<tr class="tr_b<?php echo $j?>"> <td> </td>
											<td><input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 fmt_number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
											<td><input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 fmt_number" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
											<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary" onclick="removerow_b('<?php echo $j?>');">-</button><?php } ?></td></tr>
										<?php } 
										 $j++;
										} } else {?>
											<tr class="analyserow_b">
												<td> B -  Échéances Mensuelles  BICIG </td>
												<td>
													<input type="number" value="<?php echo $bs1?>" name="amount_b1[]" class="form-control amount_b1 number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/>
												</td>
												<td>
													<input type="number" value="<?php echo $b_s2[$key]?>" name="amount_b2[]" class="form-control amount_b2 number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
										...
										//  echo $risk_analysis['amount_c_s1'];
											...
											?>
												<tr class="analyserow_c">
													...
													<td>                          
														<input type="number" value="<?php echo $cs1;?>" name="amount_c1[]" class="form-control amount_c1 number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
													</td>
													<td>
														<input type="number" value="<?php echo $c_s2[$key];?>" name="amount_c2[]" class="form-control amount_c2 number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
													</td>
													 <td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_c" onclick="addrow_c()">+</button><?php } ?></td>
												</tr>

											<?php } else {?>
												<tr class="tr_c<?php echo $k;?>"> <td> </td>
												<td><input type="number" value="<?php echo $cs1?>" name="amount_c1[]" class="form-control amount_c1 number" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?>/></td>
												<td><input type="number" value="<?php echo $c_s2[$key]?>" name="amount_c2[]" class="form-control amount_c2" min="0" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> /></td>
												<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_c('<?php echo $k; ?>');">-</button><?php } ?></td></tr>
											<?php } } }else { ?>

												<tr class="analyserow_c">
													<td> C - Echéances Mensuelles Autres </td>
													<td>                          
														<input type="number" value="" name="amount_c1[]" class="form-control amount_c1 number" onkeydown="calculateSum()" onkeyup="calculateSum()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
													</td>
													<td>
														<input type="number" value="" name="amount_c2[]" class="form-control amount_c2 number" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" min="0" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){ echo "disabled" ; }?> />
													</td>
													 <td><?php if ($param == "edit" || in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){ ?><button type="button" class="btn btn-primary addrow_c" onclick="addrow_c()">+</button><?php } ?></td>
												</tr>
									...
									<tr class="total_analyse">
										...
										<td>
											...
											<input type="number" id="total_form1" value="<?php echo $risk_analysis['total_s1'];?>" name="total_form1" class="form-control" min="0" required readonly/>
										...
										<td>
											...
											<input type="number" id="total_forms2" value="<?php echo $risk_analysis['total_s2'];?>" name="total_forms2" class="form-control" min="0" required readonly/>
									...
									<tr class="total_analyse">
										...
										<td colspan="2">
											...
											<input type="number" id="sal_moyen" value="<?php echo $risk_analysis['average_residual_salary']; ?>" name="sal_moyen" class="form-control" min="0" required readonly/>
										...
										<tr>                                              
										<td colspan=2>
										    <div class="analysesalresiduel-msg"></div>
										...
										<td>
        									<?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?>
        									<button type="button" class="btn btn-primary  pull-right submitAnalyseSalBtn" onclick="save_average_salary_riskform();">Soumettre</button>
        										<?php } ?>
        								</td>
									</tr>
                                    <tr>
                                        <td colspan="3">
                                            <div class="alert alert-danger salary_condition">
                                              <?php 
                                                    ...
                                                    $avg_s = $this->Common_model->get_maximum_salary_residuel($risk_analysis['average_residual_salary']);
                                                    if($avg_s){
                                                        echo "Droit de credit maximum ".$avg_s;
                                                    }
                                                    else{
                                                        echo "No Eligible";
                                                    }
                                            ...
                                            <div class="alert alert-success loan_condition" <?php if($risk_analysis['updated_loanamount']){ ?> style="display:block" <?php } else {?> style="display:none" <?php } ?>>
                                                <?php  if($risk_analysis['updated_loanamount']) echo "Le montant du prêt est mis à jour en fonction du maximum du droit de crédit";//"Loan Amount is updated according to Droit de credit maximum";?>
                                            </div>
                                        </td>
                                    </tr>
              ...
              <div class="col-md-6 engagement_section">
                <div class="table-responsive">
                  <table class="table table-condensed table-hover">
                    <thead>
                      <tr class="info">
                    ...
                    <tbody>
                      <form id="FormAnalyseNew2" method="post">
							...
							<tr>
								...
								<td>
									<input type="number" value="" name="solde_du_cav" class="form-control analysis_cal2 solde_du_cav_c" onkeydown="calculateEngg()" onkeyup="calculateEngg()" min="0" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?>/>
									
									
								</td>
								<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?> 
									<button type="button" class="btn btn-primary addrow_cav" onclick="addrow_cav()">+</button>
									 <?php } ?>
								</td>
							</tr>
							<?php } else {
							...
							<tr class="tr_cav<?php echo $r_count;?>">
								...
								<td>
									<input type="number" value="<?php echo $rd->value;?>" name="solde_du_cav" class="form-control analysis_cal2 solde_du_cav_c" onkeydown="calculateEngg()" onkeyup="calculateEngg()" min="0" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr class="analysenew2">
								...
								<td>
										...
										<input type="number"  value="<?php echo $risk_analysis['solde_du_csfbm'];?>" name="solde_du_csfbm" class="form-control analysis_cal2 solde_du_csfbm_c" onkeydown="calculateEngg()" onkeyup="calculateEngg()" min="0" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr>
								...
								<td>
										...
										<input type="number" id="montant_de_pret_sollicite" value="<?php echo $loan_details['loan_amt'] * - 1 ?>" name="montant_de_pret_sollicite" class="form-control analysis_cal2" min="0"   readonly />
							...
							<tr>
								...
								<td>
									<input type="number"  value="" name="solde_encours" class="form-control analysis_cal2 solde_encours_c" onkeydown="calculateEngg()" onkeyup="calculateEngg()" min="0" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
									
									
								</td>
								<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?> 
									<button type="button" class="btn btn-primary addrow_encour" onclick="addrow_encour()">+</button>
								<?php } ?>
								</td>
							</tr>
							<?php } else {
							...
							<tr class="tr_en<?php echo $r_count1;?>">
								...
								<td>
									<input type="number"  value="<?php echo $rd1->value ; ?>" name="solde_encours" class="form-control analysis_cal2 solde_encours_c" min="0" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> />
							...
							<tr>                                              
								...
								<input type="hidden" value="credit_scolair" name="loan_type" class="form-control"/>
			...
			<div class="col-md-12 ">
        				...
        				<table class="table table-condensed table-hover">
        					...
        					<tbody>                                                         
        						...
        						<form id="coefficient_form1" method="post"> 
        							...
        							<tr class="tr_coff10">
        								<td><input type="number" id="st1_10" class="form-control salary_t1 number" name="salary[]" min="0" onblur="calculateRow('0');" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="mt1_10" class="form-control mois_t1 number" name="mois[]" min="0" onblur="calculateRow('0');" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="at1_10" class="form-control ans_t1 number" name="ans[]" min="0" onblur="calculateRow('0');" readonly ></td>

        								<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?> <button type="button" class="btn btn-primary addrow_coff1" onclick="addrow_coff1()">+</button><?php } ?></td>
        							</tr>
        							<?php } else { 
        							...
        							<tr class="tr_coff1<?php echo $l;?>">
        								<td><input type="number" id="st1_1<?php echo $l;?>" class="form-control salary_t1 number" name="salary[]" min="0" onblur="calculateRow('<?php echo $l;?>');" value="<?php echo $value->salary;?>" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								<td><input type="number" id="mt1_1<?php echo $l;?>" class="form-control mois_t1 number" name="mois[]" min="0" onblur="calculateRow('<?php echo $l;?>');" value="<?php echo $value->mois;?>" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
        								...
        								<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff1" onclick="addrow_coff1()">+</button><?php } ?></td>
        								<?php } else {?>
        								<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_coff1('<?php echo $l;?>')">-</button><?php } ?></td>
        								<?php } ?>
        							</tr>
						...
						<div class="table-responsive">
							<table class="table table-condensed table-hover">
								...
								<tbody>                                                         
									...
									<tr>
										<td><input type="number" id="rt2_20" class="form-control remboursement_t2 number" name="remboursement[]" min="0" value="<?php echo $loan_details['pmnt'];?>" onblur="calculateRemRow('0');" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php }else{ ?>  readonly <?php } ?> ></td>
										<td><input type="number" id="mt2_20" class="form-control mois_t2 number" name="mois1[]" min="0" value="<?php echo $loan_details['loan_term'];?>" onblur="calculateRemRow('0');" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $loan_details['final_status'] == "Disbursement"){?> readonly <?php }else{ ?>  readonly <?php } ?> ></td>
										<td><input type="number" id="at2_20" class="form-control ans_t2 number" name="ans1[]" min="0" value="<?php echo $loan_details['loan_term']*$loan_details['pmnt'];?>" onblur="calculateRemRow('0');" readonly ></td>
										<td><?php if ($param == "edit" & in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff2" onclick="addrow_coff2()">+</button><?php } ?></td>
									</tr>
									 <?php } else {
										...
										<td><input type="number" id="rt2_2<?php echo $m;?>" class="form-control remboursement_t2 number" name="remboursement[]" min="0" onblur="calculateRemRow('<?php echo $m;?>');" value="<?php echo $value1->rem;?>" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $key=="0" || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?>  ></td>
										<td><input type="number" id="mt2_2<?php echo $m;?>" class="form-control mois_t2 number" name="mois1[]" min="0" onblur="calculateRemRow('<?php echo $m;?>');" value="<?php echo $value1->mois;?>" <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission')) || $key=="0" || $loan_details['final_status'] == "Disbursement"){?> readonly <?php } ?> ></td>
										...
										<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary addrow_coff2" onclick="addrow_coff2()">+</button><?php } ?></td>
										<?php } else {?>
										<td><?php if ($param == "edit" && in_array('6_2', $this->session->userdata('portal_permission')) && $loan_details['final_status'] != "Disbursement"){?><button type="button" class="btn btn-primary" onclick="removerow_coff2('<?php echo $m;?>')">-</button><?php } ?></td>
										<?php } ?>
									</tr>
									 <?php $m++ ;} }?>
									<tr class="coff2">
				...
				<div class="col-md-12">
					<div class="col-md-3">
						...
						<input type="text" class="form-control" name="coeff" id="coeff" value="<?php echo $risk_analysis['coefficient_score']; ?>" readonly>
					</div>
				</div>
			</div>
               <div class="row">
						...
						<tbody>
							...
							<tr>
								...
								<div>
										...
										<input type="input" id="opening_date" value="<?php echo !empty($customer->opening_date) ? date("d-m-Y", strtotime($customer->opening_date)):"";?>" name="" class="form-control" min="0" disabled readonly />
						...
						<tbody>                                                         
							...
							<tr>
								...
								<div>
									...
									<input type="number" value="<?php echo $month_val;?>" name="" class="form-control" min="0" <?php if($diff->m <= 6 && $diff->y ==0){?> style="color:red" <?php } else {?> style="color:green"  <?php } ?>disabled readonly />
								...
								<div>
										...
										<input type="number" value="<?php echo $diff->y;?>" name="" class="form-control" min="0" disabled readonly />
     ...
     <!-- start Tab-10 section -->
      ...
      if($this->session->userdata('role') == "11" ) {
       ...
       if($param=="edit" && in_array('6_6', $this->session->userdata('portal_permission'))) {
           ...
           <div class="revision_section">
            ...
            <form id="loanEditForm" action="#"  method="post">
              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" value="Prêt CAC" readonly disabled>
              ...
              <div class="col-md-3">
                ...
                <span class="input-group-addon">F CFA</span>
                 <?php if ($current_user_decision['review'] == 1){?>
                    ...
                    <?php $avg_sal_residuel = $risk_analysis['average_residual_salary'];
                       $avg_amount = $this->Common_model->get_maximum_salary_residuel($avg_sal_residuel);
                    ?>
              
              <select class="form-control" id="loan_amt_drop" onchange='CheckColors(this.value);' required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
             
                <option value="other" >Saisir un Montant</option>
                <?php if($avg_sal_residuel) {?>
                
                <?php if($avg_amount >= 300000){?>
                <option value="300000" <?php if($loan_details['loan_amt']=="300000"){echo "selected";}?>>300 000</option>
                <?php } ?>
                <?php if($avg_amount >= 450000){?>
                <option value="450000" <?php if($loan_details['loan_amt']=="450000"){echo "selected";}?>>450 000</option>
                <?php } ?>
                <?php if($avg_amount >= 750000){?>
                <option value="750000" <?php if($loan_details['loan_amt']=="750000"){echo "selected";}?>>750 000</option>
                <?php } ?>
                <?php if($avg_amount >= 1500000){?>
                <option value="1500000" <?php if($loan_details['loan_amt']=="1500000"){echo "selected";}?>>1 500 000</option>
                <?php } ?>
                ...
                <input type="number" class="form-control numberformat" id="loan_amt"  name="loan_amt" 
                <?php
                $amountArray=['300000','450000','750000','1500000'];
               ...
               <select class="form-control" id="loan_object_drop" onchange='add_object(this.value);' required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
                
                <option value="conges a la carte" <?php if(strtolower($loan_details['loan_object']) == "conges a la carte") echo "selected";?> >Conges a la carte </option>
                <option value="other" <?php if($loan_details['loan_object'] != "credit confort" &&  strtolower($loan_details['loan_object']) != "conges a la carte" && $loan_details['loan_object'] != "fetes a la carte") echo "selected";?> >Other</option>
              </select>

                <input type="text" class="form-control" id="loan_object"  name="loan_object"  value="<?php echo $loan_details['loan_object'];?>"  <?php if($loan_details['loan_object'] != "credit confort" &&  $loan_details['loan_object'] != "Conges a la carte" && $loan_details['loan_object'] != "conges a la carte"){?> style='display:block;' <?php } else {?> style='display:none;'  <?php } ?> >
              ...
              <div class="row">
                ...
                <select class="form-control numberformat" name="loan_term" id="loan_term" required <?php if ($param == "view" || !in_array('6_2', $this->session->userdata('portal_permission'))){ echo "disabled" ; }?> >
                
                <option value="1" <?php if($loan_details['loan_term']=="1"){echo "selected";}?>>1</option>
                <option value="2" <?php if($loan_details['loan_term']=="2"){echo "selected";}?>>2</option>
                <option value="3" <?php if($loan_details['loan_term']=="3"){echo "selected";}?>>3</option>
                <option value="4" <?php if($loan_details['loan_term']=="4"){echo "selected";}?>>4</option>
                
              </select>
              <?php }else{?>
               <input type="text" class="form-control" value="<?php echo $loan_details['loan_object']?>" id="loan_term" readonly >
              <?php }?>
             ...
             <select class="form-control" name="loan_schedule" id="loan_schedule" required readonly>
              ...
              $am=new Class_Amort();
              $loan_interest =$loan_details['loan_interest'];
									$vat_on_interest=$appformD[0]['loan_tax'] ?: '19.25'; 
									$rt=($loan_interest*(1+$vat_on_interest/100));
             ...
             <div style="display:block" class="Approbation">
                ...
                <div class="row">
                  ...
                  <div style="margin-top:20px;margin-bottom:30px; padding-bottom:60px; border-bottom:solid 1px #ddd;">
                    ...
                    <button type="button" class="btn btn-primary pull-right clearfix" id="commentsub" onclick="commentsubmit()">SOUMETTRE</button>
                  </div> 
                  </div> 
...
<script src="<?php echo  base_url(); ?>assets/js/demo-skin-changer.js"></script> 
  ...
  var document_status__url = "<?php echo base_url('Customer_Product/change_document_status/credit_scolair/').$loan_details['loan_id']?>";
  var system_upload_url  =  "<?php echo base_url('Customer_Product/upload_systemfiles/credit_scolair/').$loan_details['loan_id'];?>";
  var checklist_upload_url = "<?php echo base_url('Customer_Product/upload_checklistfiles/credit_scolair/').$loan_details['loan_id'];?>";
  var risk_upload_url =  "<?php echo base_url('Customer_Product/uploadfile_risk_analysis/credit_scolair/').$loan_details['loan_id'];?>";
  var preview_url ="<?php echo base_url('Customer_Product/view_uploaded_documents/credit_scolair/').$loan_details['loan_id']?>";
  var decision_url = '<?php echo base_url("Customer_Product/comment_manager/credit_scolair/").$loan_details['loan_id'];?>';
...
function isNumber(evt) {
  ...
  <script type="text/javascript">
	...
	function addrow_a(){
	    	rowcount_a++; 
			$('<tr class="tr_a'+rowcount_a+'"> <td> </td><td><input type="number" value="" name="amount_a1[]" class="form-control amount_a1" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" /></td><td><input type="number" value="" name="amount_a2[]" class="form-control amount_a2" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" /></td><td><button type="button" class="btn btn-primary" onclick="removerow_a('+rowcount_a+');">-</button></td></tr>').insertBefore('.analyserow_b');
  ...
  <?php } ?>
    ...
    function addrow_b(){
        rowcount_b++; 
		$('<tr class="tr_b'+rowcount_b+'"> <td> </td><td><input type="number" value="" name="amount_b1[]" class="form-control amount_b1" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" /></td><td><input type="number" value="" name="amount_b2[]" class="form-control amount_b2" min="0" required onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" /></td><td><button type="button" class="btn btn-primary" onclick="removerow_b('+rowcount_b+');">-</button></td></tr>').insertBefore('.analyserow_c');
	...
	function addrow_c(){
	   rowcount_c++; 
	   $('<tr class="tr_c'+rowcount_c+'"> <td> </td><td><input type="number" value="" name="amount_c1[]" class="form-control amount_c1" min="0" required onkeydown="calculateSum()" onkeyup="calculateSum()" /></td><td><input type="number" value="" name="amount_c2[]" class="form-control amount_c2" min="0" onkeydown="calculateSumS2()" onkeyup="calculateSumS2()" required /></td><td><button type="button" class="btn btn-primary" onclick="removerow_c('+rowcount_c+');">-</button></td></tr>').insertAfter('.analyserow_c');
...
<?php }?>
  ...
  function removerow_a(element_row){
   ...
   function calculateSum(){
        ...
        var moyen_amount  = show_sal_moyen(sal_moyen);
	 ...
	 // Analyse Form - s2 calculation Form 1
	  ...
	  function show_sal_moyen(sal_moyen){
	     var moyen_amount;
	     if(sal_moyen < 150000)
          {
            $(".salary_condition").html("No Eligible");
          }
          else if(sal_moyen >= 150001 && sal_moyen <= 200000)
          {
              $(".salary_condition").html("Droit de credit maximun XAF 300 000");
              moyen_amount = 300000;
          }
          else if(sal_moyen >= 200001 && sal_moyen <= 400000)
          {
              $(".salary_condition").html("Droit de credit maximum XAF 500 000");
               moyen_amount = 500000;
          }
          else if(sal_moyen >= 400001 && sal_moyen <= 600000)
          {
              $(".salary_condition").html("Droit de credit maximum XAF 750 000");
               moyen_amount = 750000;
          }
          else if(sal_moyen >= 600001 && sal_moyen <= 800000)
          {
              $(".salary_condition").html("Droit de credit maximum XAF 1 000 000");
              moyen_amount = 1000000;
          }
          else if(sal_moyen >= 800001 && sal_moyen <= 1000000)
          {
              $(".salary_condition").html("Droit de credit maximum XAF 1 500 000");
              moyen_amount = 1500000;
          }
    ...
    function calculateSumT1(){
	 ...
	 function save_average_salary_riskform(){
	    ...
	    if(confirm("Voulez-Vous Poursuivre ?")){
    		...
    		var sal_moyen = $("#sal_moyen").val();
        	var moyen_amount  = show_sal_moyen(sal_moyen);
            var loan_amount = $("#montant_de_pret_sollicite").val();
            var loan_term = $("#loan_term").val();
            var loan_amount = loan_amount.replace('-', '');
            var new_loanamount;
            if(moyen_amount){
                if(moyen_amount < loan_amount)
                {
                    new_loanamount = moyen_amount;
                }
                else{
                    new_loanamount ='';
                }
            ...
            if(new_loanamount){
                $(".loan_condition").html("Le montant du prêt est entrain d'être  révisé selon le maximum du droit de crédit");
            }
            else{
                $(".loan_condition").html("");
            }
        	...
        	setTimeout(function(){
        	        ...
        	        $.ajax({
        			type: "POST", 
        				url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskAnalysis_average_salary");?>',
        				data:{'amount_a1' : amount_a1,'amount_a2' : amount_a2,'amount_b1':amount_b1,'amount_b2':amount_b2,'amount_c1' : amount_c1,'amount_c2':amount_c2,'total_form1':total_form1,'total_forms2':total_forms2,'loan_id':loan_id,'new_loanamount':new_loanamount,'loan_term':loan_term },
        				//contentType: false,
        				cache: false,
        				//processData: false,
        				beforeSend: function(){
        				...
        				success: function(resp){
        					...
        					if(new_loanamount){
        					  ...
        					  $(".loan_condition").css('display','block');
        					
        					if(resp=="success"){                                    
        		              $('.analysesalresiduel-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully And Workflow Initiated').addClass('alert alert-success fade in').fadeOut(5000);  
                            }
        		            else if(resp == "no_workflow_matched"){
        		              $('.analysesalresiduel-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully But No Workflow Matched ').addClass('alert alert-warning fade in').fadeOut(5000);  
        		               }
        		            else if(resp == "success_new"){
        		              $('.analysesalresiduel-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully And Workflow Reinitiated ').addClass('alert alert-success fade in').fadeOut(5000);  
        		                }
        		            else if(resp == "no_workflow_change"){
        		              $('.analysesalresiduel-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Record Saved Successfully').addClass('alert alert-success fade in').fadeOut(5000);  
        		                }
        					}
        					else{
        					    $(".loan_condition").css('display','none');
        					}
        					
        					 setTimeout(function(){     
        					        $(".salary_section").load(window.location.href + " .salary_section");
        		                    $(".coeff_section").load(window.location.href + " .coeff_section");
        		                    $(".bg-header").load(window.location.href + " .bg-header");
        		                    $(".action-panel").load(window.location.href + " .action-panel");
        		                    $(".tracking_section").load(window.location.href + " .tracking_section");
        		                    $(".revision_section").load(window.location.href + " .revision_section");
	...
	function save_salary_data(){
		...
		$.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskAnalysis_coefficient_salary");?>',
	...
	setTimeout(function(){
        ...
        $.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskAnalysis_coefficient_remboursement");?>',
	...
	function save_total_engagement_riskform(){
		...
		setTimeout(function(){
			$.ajax({
			  type: "POST", 
				url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_total_engagements");?>',
				data:{'solde_du_cav':solde_du_cav,'solde_du_csfbm':solde_du_csfbm,'solde_encours':solde_encours,'loan_id':loan_id,'total_analyse_cal' : total_analyse_cal},
				cache: false,
				beforeSend: function(){
					$(".showajaxrequest2").html('');
				},
				success: function(response){
		            ...
		            if(response=="success"){                                    
		              ...
		              $('.analysecumul-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Enregistré avec succès').addClass('alert alert-success fade in').fadeOut(5000);  
		                }
		            else{
		            $('.analysecumul-msg').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Error in saving record').addClass('alert alert-danger fade in');
		             ...
		             setTimeout(function(){ 
		                 $(".engagement_sectionr").load(window.location.href + " .engagement_section" );
		                 $(".bg-header").load(window.location.href + " .bg-header" );
		                 $(".tracking_section").load(window.location.href + " .tracking_section" );
		                 $(".decision_section").load(window.location.href + " .decision_section" );
		                 $('.submitAnalyseBtn').removeAttr("disabled");
		                 }, 1000); 
   ...
   function notificationcall(data, status)
  {
   ...
   $("#cadMemoForm").validate({
      ...
      submitHandler: function(form) { 
        ...
        $.ajax({
          url: '<?php echo base_url("Customer_Product/manage_cad_memorandum/credit_scolair/").$loan_details['loan_id'];?>',
          type: 'POST',
          data: $(form).serialize(),
          beforeSend: function(){
          ...
          success: function(response) {
            ...
            if(response=="success"){                                    
              $('.memo_message').html('<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button><i class="fa fa-check-circle fa-fw fa-lg"></i> Enregistré avec succès').addClass('alert alert-success fade in').fadeOut(5000);  
                setTimeout(function(){                      
                  location.reload();
                 }, 1500); 
  ...
  {   
   ...
   $("#emailHistoryForm").validate({
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_history_interaction_customer/credit_scolair/email/").$loan_details['loan_id'];?>',
   ...
   $("#smsHistoryForm").validate({
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_history_interaction/credit_scolair/sms/").$loan_details['loan_id'];?>',
          data:$(formdata).serialize(),
          beforeSend: function(){
   ...
   $("#interviewHistoryForm").validate({
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_history_interaction/credit_scolair/interview_telephone/").$loan_details['loan_id'];?>',
          data:$(formdata).serialize(),
          beforeSend: function(){
          ...
          success: function(response) {
            ...
            if($.trim(response)=="success"){
              ...
              $('.history_msg').html('<div class="alert alert-success">Enregistré avec succès.</div>'); 
              setTimeout(function() {                
                        location.reload();
              }, 2000);                               
            }
   ...
   $("#addnewcustomer").validate({
    ...
    rules: {        
      ...
      submitHandler: function(form) {     
        ...
        $.ajax({
          type:'POST',
          url:'<?php echo base_url("Customer_Product/manage_business_loan_data/credit_scolair/").$loan_details['loan_id'];?>',
          data:$(formdata).serialize(),
          beforeSend: function(){
          ...
          success: function(response) {
            ...
            if($.trim(response)=="success"){
              ...
              $('.response-msg').html('<div class="alert alert-success"><strong>Success!</strong> Détails enregistrés avec succès.</div>'); 
              setTimeout(function() {                
                    location.reload();
                      }, 1000);                               
                      }else{                                             
...
//$('#loanEditFormdetais').submit(function(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/edit_loan");?>',
        ...
        success:function(resp){
           ...
           if($.trim(resp)=='1'){
                $('.editloanmsgdetails').html('<div class="alert alert-success"><i class="fa fa-check-circle fa-fw fa-lg"></i><strong>Success!</strong> Enregistrer la mise à jour avec succès!</div>');
              setTimeout(function() {
                location.reload();
              }, 1500);
            }else{
  ...
  <script>
    ...
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_current_monthly_credit");?>',
 ...
 $(document).on("keyup click", ".qty223", function() {
    
    
    var form = $("#FormCurrentmonthly2");
    var serializedFormR =form.serialize(); 
    console.log(serializedFormR);
    $(".riskcurrentmonthloder2").css("display","inline");
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
    ...
    $(document).on("change", ".qty2232", function() {
    
    var form = $("#Formfinancial_situation2date");
    var serializedFormR =form.serialize(); 
    console.log(serializedFormR);
    $(".riskcurrentmonthloder2").css("display","inline");
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_current_monthly_credit2");?>',
        data:$.trim(serializedFormR),
        //contentType: false,
        cache: false,
        //processData: false,
   ...
   $(document).on("keyup click", ".qty2233", function() {

    var testfunction  = 0;
    $(".qty2233").each(function(){
      if($(this).val() !== ""){
        // testfunction += parseFloat($(this).val());
      }else{
        $(this).val(0);
      }
    });
    
        var rest=$( "#creditencour" ).val();
    var monthaly=$( "#loanannualHidden" ).val();
    var Sumofloans= parseFloat(rest) + parseFloat(monthaly) ;
    $("#loanannual").val(Sumofloans);
    var anualSalary=$( "#salaryAnnual2" ).val();

    $("#score").val(Math.round((Sumofloans/anualSalary)*100));
    $("#score2").val(Math.round((Sumofloans/anualSalary)*100));
    $("#score3").val(Math.round((Sumofloans/anualSalary)*100));

     var form = $("#Formfinancial_situation22");
    var serializedFormR =form.serialize(); 
    console.log(serializedFormR);
    $(".riskcurrentmonthloder2").css("display","inline");
    setTimeout(function() { 
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_current_monthly_credit3");?>',
        data:$.trim(serializedFormR),
        //contentType: false,
        cache: false,
        //processData: false,
  ...
  $(document).on("keyup click", ".qty21", function() {     
    ...
    setTimeout(function() {
      $.ajax({
      type: "POST", 
        url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_monthly_payment_new_loan");?>',
        data:$.trim(serializedFormR),
        //contentType: false,
        cache: false,
        //processData: false,
  ...
  $(document).on("keyup click", ".qty32", function() {
    ...
    $(".risksituationloder2").css("display","inline");
      setTimeout(function() { 
        $.ajax({
          type: "POST", 
            url:'<?php echo base_url("PP_CONGES_A_LA_CARTE/riskanalysis_financial_situation");?>',       data:$.trim(serializedFormRf), 
            cache: false,
            beforeSend: function(){
              $(".showajaxrequestnew2").html('');
            },
...
$(document).on('change', '#vehicule_uploadfile', function(){
  ...
  $.ajax({
    url:"<?php echo base_url('PP_CONGES_A_LA_CARTE/uploadfile_collateral_vehicule');?>",
    method:"POST",
    data: formdata,
    contentType: false,
    cache: false,
...
$(document).on('change', '#deposit_files', function(){
  ...
  $.ajax({
    url:"<?php echo base_url('PP_CONGES_A_LA_CARTE/uploadfile_collateral_deposit');?>",
    method:"POST",
    data: formdata,
    contentType: false,
    cache: false,
...
$(document).on('change', '#upload_maison', function(){
  ...
  $.ajax({
    url:"<?php echo base_url('PP_CONGES_A_LA_CARTE/uploadfile_collateral_maison');?>",
    method:"POST",
    data: formdata,
    contentType: false,
    cache: false,
...
$(document).on('change', '#excemption_files', function(){ 
  ...
  $.ajax({
    url:"<?php echo base_url('PP_CONGES_A_LA_CARTE/uploadfile_collateral_excemption');?>",
    method:"POST",
    data: formdata,
    contentType: false,
    cache: false,
