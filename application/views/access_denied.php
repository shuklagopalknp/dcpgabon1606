						...
						<div class="row">
							<div class="col-xs-12">
								<div id="error-box-inner">
									<img src="<?php echo base_url("assets/img/logo.png");?>" alt="DCP - Login Page">
								</div>
								<h1>Access Denied(403)</h1>
								<p>Secure content is being accessed</p>
								<div id="gears">
								...
								<p>
									Go back to <a href="<?php echo base_url('Login/logout');?>">homepage</a>.
								</p>
							</div>
						</div>
					</div>
