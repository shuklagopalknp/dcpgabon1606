                  ...
                  <div class="bg-header">
                    <div class="well well-sm well-primary" style="background-color:transparent !important">
                      <div class="row well_row">
                        ...
                        <div class="col-xs-2 no-padding"><?php echo $risk_analysis['credit_amount'] ?? '';?></div>
                      </div>
                      <div class="row well_row">
                       ...
                       if($risk_analysis['start_date']) echo date("d-m-Y", strtotime($risk_analysis['start_date'])) ?? '';?></div>
                        <div class="col-xs-2 bold no-padding">Date d'échéance:</div>
                        <div class="col-xs-2 no-padding"><?php
                       if($risk_analysis['end_date']) echo date("d-m-Y", strtotime($risk_analysis['end_date'])) ?? '';?></div>
                      </div>
                      <div class="row well_row">
                      
                       <div class="col-xs-2 bold no-padding">Total Tirage:</div>
                        <div class="col-xs-2 no-padding"><?php echo count($withdraw_workflow);?></div>
                        <div class="col-xs-2 bold no-padding">Montant Disponible:</div>
                        <div class="col-xs-2 no-padding"><?php echo $withdraw_balance['sum'];?></div>
                         <div class="col-xs-2 bold no-padding">Taux d'interet:</div>
                        <div class="col-xs-2 no-padding"><?php echo $risk_analysis['tax'] ?? '';?></div>
                      </div>
                      <div class="row well_row">
                       <div class="col-xs-2 bold no-padding">Agence:</div>
                        <div class="col-xs-2 no-padding"><?php echo $branch_rec['branch_name'];?></div>
            ...
            <?php if($this->session->userdata('role') == '2'){?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                      ...
                      <input type="number" class="form-control"  name="remaining_amount" autocomplete="off" value="<?php if($withdraw_balance['sum']) echo $risk_analysis['credit_amount'] - $withdraw_balance['sum']; ?>"  min="1" readonly >
                      </div>
               ...
               <form id="observation_withdraw" method="post" >
                <table class="table table-condensed table-hover">
                      <thead>
                        ...
                        <?php }
                            else if($withdraw_decision['review']=="1"){ 
          ...
          <?php if(in_array('10_6', $this->session->userdata('portal_permission')) && $this->session->userdata('role') != "11" && $this->session->userdata('role') != "9" && $this->session->userdata('role') != "12"  ) {?>
            <form id="DecisionStatusdetails" method="post">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label>SELECTIONNER VOTRE AVIS <?=$loan_details['review']?></label>    
