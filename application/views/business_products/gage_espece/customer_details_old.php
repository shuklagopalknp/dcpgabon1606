                  ...
                  <div class="bg-header">
                    <div class="well well-sm well-primary" style="background-color:transparent !important">
                      <div class="row well_row">
                        ...
                        <div class="col-xs-2 bold no-padding">Prénom:</div>
                      ...
                      <div class="row well_row">
                        <div class="col-xs-2 bold no-padding">Echéance:</div>
                        ...
                        <div class="col-xs-2 bold no-padding">Taux d’intérêt annuel:</div>
                        <div class="col-xs-2 no-padding"><?php  echo $risk_analysis_facility['tax_interest'] ?? '';?>%</div>
                        <div class="col-xs-2 bold no-padding">Déroulement de la transaction:</div>
                        <div class="col-xs-2 no-padding"><?php  echo $risk_analysis_facility['transaction_unfolded'] ?? '';?></div>
                      </div>
                      <div class="row well_row">
                        <div class="col-xs-2 bold no-padding">Modalités d’utilisation:</div>
                        ...
                        <div class="col-xs-2 bold no-padding">Prime d’assurance Décès Bénéficiaire:</div>
           ...
           <h3 id="tab-title" style="margin-top: 2%;"><span>TITRES DE CREANCE NANTIS</span></h3>
             <form id="riskAnalyseForm" method="post">
                ...
                <div class="col-md-3">
                  ...
                  <label>Date d’Echéance <span style="color:red">*</span></label>
                 ...
                 <div class="col-md-3">
                  ...
                  <label>Etablissement Dépositaire <span style="color:red">*</span></label>
...
<form id="riskAnalyseForm2" method="post">
                ...
                <div class="col-md-3">
                  ...
                  <label>Nature de la Facilité</label>
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                  ...
                  <label>Echéance <span style="color:red">*</span></label>
                 ...
                 <div class="col-md-3">
                  ...
                  <label>Taux d’intérêt annuel <span style="color:red">*</span></label>
                 ...
                 <div class="col-md-3">
                  ...
                  <label>Déroulement de la transaction <span style="color:red">*</span></label>
                 ...
                 <div class="col-md-3">
                  ...
                  <label>Modalités d’utilisation <span style="color:red">*</span></label>
                ...
                <div class="col-md-3">
                  ...
                  <label>Prime d’assurance Décès Bénéficiaire <span style="color:red">*</span></label>
