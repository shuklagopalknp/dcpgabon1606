			...
			<div id="content-header" class="clearfix">
				<div class="pull-left">
					<ol class="breadcrumb">
						...
						<li class="active"><span>GAGE ESPECE</span></li>
					</ol>
				</div>
			</div>
			<div class="main-box-body clearfix">
                                <?php if (in_array('8_1', $this->session->userdata('portal_permission'))){?>
				<a href="javascript:void(0);" class="btn btn-primary  openBtn"  data-toggle="modal" data-target="#myModal">
					<i class="fa fa-plus-circle fa-lg"></i> Gage Espece Products
				</a>
                                <?php } ?>
											    ...
											    <tr id="rowid<?php echo $ld['loan_id'];?>">
											    	...
											    	<td>
											    		<?php if($ld['sub_product'] == '1'){
											    			echo  strtoupper("Personne Physique");
											    		}
											    		else if($ld['sub_product'] == '2'){
											    			echo strtoupper("Ets & Assimiles");
											    		}
											    		else if($ld['sub_product'] == '3'){
											    			echo strtoupper("Societe Commerciale");
											    		}?>
											    	</td>
											    	...
											    	?></td>
											    	<td class="sorting_1">
											    		<a href="<?php echo base_url('Gage_Espece/customer_details/').$ld['loan_id'];?>" class="table-link">
														<span class="fa-stack">
	...
	<div id="myModal" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
	  	<div class="modal-dialog modal-full-height modal-left modal-notify modal-info">	
			<div class="modal-content">
			   ...
			   <form role="form" method="post" id="productForm" action="<?php echo base_url("Gage_Espece/select")?>">
					<div class="modal-body">   
						...
						<div class="form-group">
							...
							<select class="form-control" name="sub_product">
								...
								<option value="1">PP Gage Espece Personne Physique</option>
								<option value="2">PP Gage Espece Ets & Assimiles</option>
								<option value="3">PP Gage Espece Societe Commerciale</option>
							</select>
