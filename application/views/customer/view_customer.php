												...
												<div class="col-md-4">
													<div class="form-group pull-right" style="margin-top:10px;">
														...
														<div class="input-group" style="width:100%">
															...
															<!--<a href="javascript:void(0);" class="btn btn-primary  openBtn"  data-toggle="modal" data-target="#AddCustomerModal" onclick="fetchbranchDetail('',<?php echo $this->session->branch; ?>);"> <i class="fa fa-plus-circle fa-lg"></i> Ajouter Un Client</a>-->
														</div>
														<?php } ?>
													</div>
												</div>
														...
														?>
															...
															<td>
																...
																<a href="javascript:void(0);" class="table-link" data-toggle="modal" data-target="#modal_edit" onclick="editcustomermodal('<?php echo $key['customer_id'];?>','')">
																 ...
																 <?php } else {?>
																 	<a href="javascript:void(0);" class="table-link" data-toggle="modal" data-target="#modal_edit" onclick="editcustomermodal('<?php echo $key['customer_id'];?>','view')">
																		<span class="fa-stack">
																			<i class="fa fa-square fa-stack-2x"></i>
																...
																<?php } ?>
												<?php if (in_array('2_4', $this->session->userdata('portal_permission'))){?>
			  ...
			  <form action="<?=base_url('Customer/import_individual_customer')?>" method="POST" enctype="multipart/form-data">
					<div class="modal-body">   
						<div class="error-msg"></div>    
		                   ...
		                   <a href="<?php echo base_url('assets/sample_customer.xlsx')?>" download> <button type="button" class="btn btn-primary waves-effect waves-light submitBtn" style="margin-top: 2%"><i class="fa fa-download fa-lg"></i>  Download Sample File</button></a>
	 ...
	 $.ajax({
	 	...
	 	success: function(resp)
	 	{
			...
			$("#bank_name").val(result[0]['bank_name']);
	 		...
	 		//console.log(result[0]['employeeStatus']);
