      ...
      <div id="content-header" class="clearfix">
        <div class="col-md-9">
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('PP_Consumer_Global_User/decovert');?>">DECOUVERT</a></li>            
                      ...
                      <div class="col-lg-8">
                        <div class="main-box clearfix" style="margin-bottom:0px;">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="nextstep-buttons">
                                  ...
                                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="text-align:center">
                                    <loan-back> <a href="<?php echo base_url('Decovert_Bank/decovert_amortization_view/').$appformD[0]['did'];?>" class="btn btn-default loan-back"  style="width:100%;margin-top:25px;">AMORTISSMENT</a> </loan-back>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <ul class="nav nav-tabs list">
                              <li class="active" onclick="active_tab('tab-1')"><a href="#tab-1">DETAILS SUR LE CLIENT</a></a></li>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <h3 id="tab-details"><span><?php echo 'F CFA '.number_format($adinfo[0]['monthly_income'],0,',',' ') ?: '-';?></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Dépenses mensuelles </label>
                                      <h3 id="tab-details"><span><?php echo 'F CFA '.number_format($adinfo[0]['monthly_expenses'],0,',',' ') ?: '-';?></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                    ...
                                    <div class="row" style="margin-bottom:5px;">
                                      <div class="form-group" style="margin-bottom:5px;">
                                       <img src="<?php echo base_url("assets/img/loading.gif");?>" class="uploaded_image" style="display:none; position: absolute; z-index: 1000; top: 34px;">
                                        ...
                                        <h3 id="tab-details"><span><?php echo $empinfo[0]['ctype'];?></span></h3>
                          ...
                          <!-- tab-1 end -->
                              ...
                              <div class="tab-pane fade" id="tab-2">
                                ...
                                <div class="row">
                                  <div class="col-lg-12">                                     
                                    ...
                                    <?php } else { ?>
                                      <button type="button" class="btn btn-sm btn-default preview" id="notification_preview" data-toggle="modal" data-target="#blankmodal"> <i class="fa fa-eye"></i> Preview</button>
                                    <?php } if(!empty($sys_docs)){ ?>
                                    ...
                                    <?php } else{ ?>
                                      <a haterref="javascript:void(0);" class="btn btn-sm btn-primary download" id="notification_download" data-toggle="modal" data-target="#blankmodal"> <i class="fa fa-cloud-download"></i> Download </a>
                                    <?php } ?>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-lg-12">                                     
                                    ...
                                    <button type="button" class="btn btn-sm btn-default preview" id="notification_CheckList_preview" data-toggle="modal" data-target="#blankmodal"> <i class="fa fa-eye"></i> Preview</button>
                                    <?php   }
                                    if(!empty($clist_docs)){ ?>
                                    ...
                                    <?php } else{ ?>
                                    <a href="javascript:void(0);" class="btn btn-sm btn-primary download" id="notification_CheckList_download" data-toggle="modal" data-target="#blankmodal"> <i class="fa fa-cloud-download"></i> Download </a>
                                    <?php } ?>
                                  </div>
                                </div>
                                <table class="table table-bordered table-hover" id="table_auto">
                                  <tr id="row_0">
                                    <td><form action="#">
                                        <div class="row">
                                          <div class="col-lg-6"> <span><a href="#">1- Copie CNI en cours de validité</a></span>
                                          </div>
                                          <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6"> <a href="#">3- Attestation de virement irrévocable</a>
                                          </div>
                                          <div class="col-lg-6">
                                            <div class="form-group">
                                              <div class="radio" style="display:inline-block">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6"> <a href="#">7- Vérification CIP (Client inconnu ou pas)</a> </div>
                                          <div class="col-lg-6">
                                            <div class="form-group">
                                              <div class="radio" style="display:inline-block">
                                        ...
                                        <div class="row">
                                          <div class="col-lg-6"> <a href="#">8- Vérification Centrale des Risques (Client inconnu ou pas)</a> </div>
                                          <div class="col-lg-6">
                                            <div class="form-group">
                                              <div class="radio" style="display:inline-block">
                                      ...
                                      <div class="table-responsive">
                                        <table class="table table-condensed table-hover">
                                          ...
                                          <form id="FormCurrentmonthly" method="post">
                                            ...
                                            <tr>
                                              <td> DECOUVERT </td>
                                              <td class="text-center"><input type="number" id="DECOUVERT" value="<?php echo $riskcurrentmonthlyvrefit[0]['decouvert'] ?: '0';?>" name="decouvert_current" class="form-control qty1"min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td> CMT </td>
                                              <td class="text-center"><input type="number" id="CMT" value="<?php echo $riskcurrentmonthlyvrefit[0]['cmt'] ?: '0';?>" name="cmt_current" class="form-control qty1" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td> CCT </td>
                                            ...
                                            <tr>
                                              <td> TOTAL </td>
                                              <td class="text-center"><input type="text" id="Ttotal" value="<?php echo $riskcurrentmonthlyvrefit[0]['total_clc'] ?: '0';?>" name="total_clc" class="form-control" min="0" readonly disabled />
                                        ...
                                        <table class="table table-condensed table-hover">
                                          ...
                                          <tbody>
                                            <form id="FormMonthlyNew" method="post">
                                              <tr>
                                                <td> CRESCO </td>
                                                <td><input type="number" id="cresco_monthly" value="<?php echo $riskpaymentnewloan[0]['cresco'] ?: $appformD[0]['pmnt'];?>" name="cresco_monthly" class="form-control qty2" min="0" readonly disabled /></td>
                                              </tr>
                                              <tr>
                                                <td> DECOUVERT </td>
                                                <td class="text-center"><input type="number" id="decouvert_monthly" value="<?php echo $appformD[0]['amount_sought_customer'] ?: '0';?>" name="decouvert_monthly" class="form-control qty2" min="0" readonly disabled /></td>
                                              </tr>
                                              <tr>
                                                <td> CMT </td>
                                                <td class="text-center"><input type="number" id="cmt_monthly" value="<?php echo $riskpaymentnewloan[0]['cmt'] ?: '0';?>" name="cmt_monthly" class="form-control qty2" min="0" readonly disabled /></td>
                                              </tr>
                                              <tr>
                                                <td> CCT </td>
                                              ...
                                              <tr>
                                                <td> TOTAL </td>
                                                <td class="text-center"><input type="text" id="total_mlc" value="<?php echo $riskpaymentnewloan[0]['total_mlc'] ?: '0';?>" name="total_mlc" class="form-control" min="0" readonly disabled />                         
                                                </td>
                                              </tr>                       
                                            </form>                     
                                            </tbody>
                                      ...
                                      <div class="table-responsive">
                                        ...
                                        <table class="table table-condensed table-hover">
                                          ...
                                          <tbody>
                                            <tr>
                                              <td> NET Salary </td>
                                              <td class="text-center"><input type="number" id="net_salary" value="<?php echo $riskfsituation[0]['net_salary'] ?: '0';?>" name="net_salary" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              ...
                                              <td class="text-center"><input type="number" id="quotitecessible" value="<?php echo $riskfsituation[0]['quotitecessible'] ?: '0';?>" name="quotitecessible" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td> Current Monthly Payments </td>
                                              <td class="text-center"><input type="text" id="current_monthly_payments" value="<?php echo $riskfsituation[0]['current_monthly_payments'] ?: '0';?>" name="current_monthly_payments" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td> New Monthly Payment </td>
                                              <td class="text-center"><input type="number" id="new_monthly_payment" value="<?php echo $riskfsituation[0]['new_monthly_payment'] ?: '0';?>" name="new_monthly_payment" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr style="background:yellow">
                                              <td> Total </td>
                                              <td class="text-center"><input type="number" id="situation_total" value="<?php echo $riskfsituation[0]['situation_total'] ?: '0';?>" name="situation_total" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td> New Loan/Income Ratio After Project </td>
                                              <td class="text-center"><input type="number" id="income_ratio_after" value="<?php echo $riskfsituation[0]['income_ratio_after'] ?: '0';?>" name="income_ratio_after" class="form-control qty3" min="0" readonly disabled /></td>
                                            </tr>
                                            <tr>
                                              <td style="color:green"> Ratio Debt </td>
                                              <td class="text-center">
                                                <div class="input-group">
                                                  <input type="text" id="coeficientendettement" value="<?php echo $riskfsituation[0]['coeficientendettement'] ?: '0';?>" name="coeficientendettement" class="form-control qty3" min="0" readonly disabled />
                                                  <span class="input-group-addon">%</span>
                                                </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="col-md-6">
                                      <div class="table-responsive">
                                        <table class="table table-condensed table-hover">
                                          ...
                                          <tbody>
                                            <tr>
                                              <td><?php echo $applicableloanratio[0]['terms'] ?: 'QUOTITE SALAIRE < 500000 F F CFA';?></td>
                                              <td class="text-center">
                                              <div class="input-group">
                                            ...
                                            <tr>
                                              <td> <?php echo $applicableloanratio[1]['terms'] ?: 'QUOTITE SALAIRE >500 000 F F CFA';?> </td>
                                              <td class="text-center">
                                              <div class="input-group">
                              ...
                              <div class="tab-pane fade" id="tab-8">
                                ...
                                <table class="table table-hover">
                                  <thead>
                                    <?php
                                    $m1=json_decode($appformD[0]['month1']);
                                    $m2=json_decode($appformD[0]['month2']);
                                    $m3=json_decode($appformD[0]['month3']);
                                    ?>
                                ...
                                <tbody>
                                  <tr>
                                      ...
                                      <td align="left"><?php echo $m1[0]->m1nms;?></td>
                                      <td align="left"><?php echo $m2[0]->m2nms;?></td>
                                      <td align="left"><?php echo $m3[0]->m3nms;?></td>
                                  </tr>
                                  <tr>
                                      <td align="left"><b><font size=2 color="#929292">REVENU SUPPLEMENTAIRE (+)</font></b></td>
                                      <td align="left"><?php echo $m1[0]->m1ai;?></td>
                                      <td align="left"><?php echo $m2[0]->m2ai;?></td>
                                      <td align="left"><?php echo $m3[0]->m3ai;?></td>        
                                  </tr>
                                  <tr>
                                      <td align="left"><font size=2 color="#929292">PAIEMENT PRET ENTREPRISE</font></td>
                                      <td align="left"><?php echo $m1[0]->m1pcl;?></td>
                                      <td align="left"><?php echo $m2[0]->m2pcl;?></td>
                                      <td align="left"><?php echo $m3[0]->m3pcl;?></td>
                                    </tr>
                                  <tr>

                                      <td  height="21" align="left"><font size=2 color="#929292">AVANCE SUR SALAIRE</font></td>
                                      <td align="left"><?php echo $m1[0]->m1ais;?></td>
                                      <td align="left"><?php echo $m2[0]->m2ais;?></td>
                                      <td align="left"><?php echo $m3[0]->m3ais;?></td>
                                  </tr>
                                  <tr>
                                      <td colspan="4"></td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td align="left"><?php echo $m1[0]->m1deduction;?></td>
                                      <td align="left"><?php echo $m2[0]->m2deduction;?></td>
                                      <td align="left"><?php echo $m3[0]->m3deduction;?></td>
                                    </tr>
                                  <tr>
                                      <td  height="20" align="left"><font size=2 color="#929292">BONUS</font></td>
                                      <td align="left"><?php echo $m1[0]->m1bonus;?></td>
                                      <td align="left"><?php echo $m2[0]->m2bonus;?></td>
                                      <td align="left"><?php echo $m3[0]->m3bonus;?></td>
                                  </tr>
                                  <tr>

                                      <td  height="20" align="left"><font size=2 color="#929292">PRIMES</font></td>
                                      <td align="left"><?php echo $m1[0]->m1primes;?></td>
                                      <td align="left"><?php echo $m2[0]->m2primes;?></td>
                                      <td align="left"><?php echo $m3[0]->m3primes;?></td>
                                  </tr>
                                  <tr>

                                      <td  height="20" align="left"><font size=2 color="#929292">GRATIFICATION 13ième mois</font></td>
                                      <td align="left"><?php echo $m1[0]->m1gratification;?></td>
                                      <td align="left"><?php echo $m2[0]->m2gratification;?></td>
                                      <td align="left"><?php echo $m3[0]->m3gratification;?></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$m1[0]->m1_total_net_salary);?></font></td>
                                      <td align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$m2[0]->m2_total_net_salary);?></font></td>
                                      <td  align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$m3[0]->m3_total_net_salary);?></font></td>
                                    </tr>
                                  <tr>
                                      <td  align="left"><font color="#000000">SALAIRE MOYEN </td>
                                      <td colspan="6"  align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$appformD[0]['average']);?></td>
                                  </tr>
                                  <tr>
                                      <td   align="left"><font color="#000000">MONTANT DECOUVERT A ACCORDER</td>
                                      <td colspan="6"   align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$appformD[0]['requested_overdraft']);?></td>
                                  </tr>
                                  <tr>
                                      <td   align="left"><font color="#000000">MONTANT SOLLICITE PAR LE CLIENT</td>
                                      <td colspan="6"   align="left"><font color="#000000">F CFA <?php echo sprintf("%01.0f",$appformD[0]['amount_sought_customer']);?></td>
                                  </tr>
                                </tbody>
                                </table>                                                       
                              </div>
                                    ...
                                    <table class="table table-striped table-hover">
                                      ...
                                      <tbody id="category-row">
                                        ...
                                        <td class="text-right"><div class="row">
                                          ...
                                          <span style="display:inline-block">
                                            <a href="<?php echo base_url('Decovert_Bank/download_collateralvehicule/').$coll['col_id']; ?>" class="btn btn-sm btn-primary waves-effect waves-light downloadv" data-toggle="tooltip" title="Download" id="collateral_downloadv-<?php echo $coll['col_id'];?>"> <i class="fa fa-cloud-download"></i></a>
                                          </span>
                                           </div>
                                         </div>
                                         </td>
                                      ...
                                      ?>
                                        ...
                                        <td class="text-right">
                                          <div class="row">
                                            ...
                                            <span style="display:inline-block">
                                              <a href="<?php echo base_url('Decovert_Bank/download_collateraldeposit/').$dept['col_id']; ?>" class="btn btn-sm btn-primary waves-effect waves-light downloadv" data-toggle="tooltip" title="Download" id="collateral_downloadv-<?php echo $dept['col_id'];?>"> <i class="fa fa-cloud-download"></i></a>
                                            </span>
                                             </div>
                                          </div>
                                         </td>
                                      ...
                                      ?>
                                        ...
                                        <div class="row">
                                          <div class="form-group">
                                            ...
                                            <span style="display:inline-block">
                                              <a href="<?php echo base_url('Decovert_Bank/download_collateralmaison/').$maison['col_id']; ?>" class="btn btn-sm btn-primary waves-effect waves-light downloadv" data-toggle="tooltip" title="Download" id="collateral_downloadv-<?php echo $maison['col_id'];?>"> <i class="fa fa-cloud-download"></i></a>
                                            </span>
                                          </div>
                                        </div>
                                        </td>
                                    ...
                                    ?>
                                      ...
                                      <td class="text-right">
                                        <div class="row">
                                          <div class="form-group">
                                          <span style="display:inline-block">
                                            <button type="button" data-toggle="tooltip" title="Preview" class="btn btn-sm btn-default preview" id="collateral_preview_excemption-<?php echo $coll4['col_id'];?>" onClick="collateral_preview_vehicule(<?php echo $coll4['col_id'];?>)"> <i class="fa fa-eye"></i></button>                                               
                                          </span>
                                          <span style="display:inline-block">
                                            <a href="<?php echo base_url('Decovert_Bank/download_collateralexcemption/').$coll4['col_id']; ?>" class="btn btn-sm btn-primary waves-effect waves-light downloadv" data-toggle="tooltip" title="Download" id="collateral_downloadv-<?php echo $coll4['col_id'];?>"> <i class="fa fa-cloud-download"></i></a>
                                          </span>
                                           </div>
                                        </div>
                                       </td>
                                        ...
                                        <div class="col-md-12">
                                          <input type="hidden" name="did"  value="<?php echo $appformD[0]['did'];?>" readonly>
                                            ...
                                            <input type="hidden"  id="manager_id" name="manager_id"  value="<?php echo $record[0]->id;?>" readonly>
                                             <input type="hidden"  id="loanamount" name="loanamount"  value="<?php echo $appformD[0]['amount_sought_customer'];?>" readonly>
          ...
          <div class="tab-pane fade in" id="tab3">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="nextstep-buttons">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="text-align:center">
                        <loan-back>
                            <a href="<?php echo base_url('Decovert_Bank/decovert_amortization_view/').$appformD[0]['did'];?>" class="btn btn-default loan-back"  style="width:100%;margin-top:25px;">AMORTISSMENT</a>
                        </loan-back>
                    </div>
                </div>
            </div>
...
<ul class="nav nav-tabs list1">
    ...
    <li onclick="active_tab('tab-15')"><a href="#tab-15">CAD</a></li>
        ...
        <div class="row">
          ...
          <div class="form-group">
            <label>Revenu mensuel </label>
            <h3 id="tab-details"><span><?php echo 'F CFA '.$adinfo[0]['monthly_income'] ?: '-';?></span></h3>
          </div>
          </div>
          <div class="col-md-3">
          <div class="form-group">
            <label>Dépenses mensuelles </label>
            <h3 id="tab-details"><span><?php echo 'F CFA '.$adinfo[0]['monthly_expenses'] ?: '-';?></span></h3>
          </div>
          </div>
          <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="tab-pane fade" id="tab-12">
                ...
                <div class="row">
                  <div class="col-lg-12">                 
                    ...
                    if(!empty($sys_docs)){ ?>
                        ...
                        <a href="<?php echo base_url('Decovert_Bank/downloadall/').$appformD[0]['did']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Download</a>
                    <?php }
                    else { ?>
                ...
                <div class="row">
                  <div class="col-lg-12">                  
                    <?php if(!empty($clist_docs)){ ?>
                        <button type="button" class="btn btn-sm btn-default  preview" data-toggle="modal" data-target="#filePreviewModal2"><i class="fa fa-eye"></i> Preview</button>
                        <a href="<?php echo base_url('Decovert_Bank/downloadallCheckList/').$appformD[0]['did']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Download</a>
                    <?php } else { ?>
      ...
      <div class="tab-pane fade" id="tab-14">
        ...
        <div class="row">
          <div class="col-lg-12">
            <?php if(!empty($risk_analysis)){ ?>
                <button type="button" class="btn btn-sm btn-default preview" data-toggle="modal" data-target="#AnalysisfilePreviewModal"><i class="fa fa-eye"></i> Preview</button>
                <a href="<?php echo base_url('Decovert_Bank/download_analysisfiles/').$appformD[0]['did']; ?>" class="btn btn-sm btn-primary download" ><i class="fa fa-cloud-download"></i> Download</a>
            <?php } else { ?>
                <button type="button" class="btn btn-sm btn-default preview" id="notification_Analysispreview" data-toggle="modal" data-target="#blankmodal"> <i class="fa fa-eye"></i> Preview</button>
                <button type="button" class="btn btn-sm btn-primary download" id="notification_analysis_download" data-toggle="modal" data-target="#blankmodal"><i class="fa fa-cloud-download"></i> Download</button>
            <?php }?>                                                   
        ...
        <div class="col-md-6">
          ...
          <table class="table table-condensed table-hover">
            ...
            <tbody>           
              ...
              <tr>
                <td> CMT </td>
                <td class="text-center"><input type="number" id="CMT" value="<?php echo $riskcurrentmonthlyvrefit[0]['cmt'] ?: '0';?>" name="cmt_current" class="form-control qty12" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> CCT </td>
              ...
              <tr>
                <td> TOTAL </td>
                <td class="text-center"><input type="text" id="Ttotal2" value="<?php echo $riskcurrentmonthlyvrefit[0]['total_clc'] ?: '0';?>" name="total_clc" class="form-control" min="0" readonly disabled />
        ...
        <div class="col-md-6">
          ...
          <table class="table table-condensed table-hover">
            ...
            <tbody>           
              <tr>
                <td> CRESCO </td>
                <td><input type="number" id="cresco_monthly2" value="<?php echo $riskpaymentnewloan[0]['cresco'] ?: $appformD[0]['pmnt'];?>" name="cresco_monthly" class="form-control qty21" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> DECOUVERT </td>
                <td class="text-center"><input type="number" id="decouvert_monthly" value="<?php echo $appformD[0]['amount_sought_customer'] ?: '0';?>" name="decouvert_monthly" class="form-control qty21" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> CMT </td>
                <td class="text-center"><input type="number" id="cmt_monthly" value="<?php echo $riskpaymentnewloan[0]['cmt'] ?: '0';?>" name="cmt_monthly" class="form-control qty21" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> CCT </td>
              ...
              <tr>
                <td> TOTAL </td>
                <td class="text-center"><input type="text" id="total_mlc2" value="<?php echo $riskpaymentnewloan[0]['total_mlc'] ?: '0';?>" name="total_mlc" class="form-control" min="0" readonly disabled />               
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="col-md-12">
          ...
          <div class="table-responsive">
            ...
            <tbody>                         
              <tr>
                <td> NET Salary </td>
                <td class="text-center"><input type="number" id="net_salary2" value="<?php echo $riskfsituation[0]['net_salary'] ?: '0';?>" name="net_salary" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> Applicable Loan/Income Ratio </td>
                <td class="text-center">
              ...
              <tr>
                <td> Quotitécessible </td>
                <td class="text-center"><input type="number" id="quotitecessible2" value="<?php echo $riskfsituation[0]['quotitecessible'] ?: '0';?>" name="quotitecessible" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> Current Monthly Payments </td>
                <td class="text-center"><input type="text" id="current_monthly_payments2" value="<?php echo $riskfsituation[0]['current_monthly_payments'] ?: '0';?>" name="current_monthly_payments" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> New Monthly Payment </td>
                <td class="text-center"><input type="number" id="new_monthly_payment2" value="<?php echo $riskfsituation[0]['new_monthly_payment'] ?: '0';?>" name="new_monthly_payment" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr style="background:yellow">
                <td> Total </td>
                <td class="text-center"><input type="number" id="situation_total2" value="<?php echo $riskfsituation[0]['situation_total'] ?: '0';?>" name="situation_total" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td> New Loan/Income Ratio After Project </td>
                <td class="text-center"><input type="number" id="income_ratio_after2" value="<?php echo $riskfsituation[0]['income_ratio_after'] ?: '0';?>" name="income_ratio_after" class="form-control qty32" min="0" readonly disabled /></td>
              </tr>
              <tr>
                <td style="color:green"> Ratio Debt </td>
                <td class="text-center">
                <div class="input-group">
                  <input type="text" id="coeficientendettement2" value="<?php echo $riskfsituation[0]['coeficientendettement'] ?: '0';?>" name="coeficientendettement" class="form-control qty32" min="0" readonly disabled />
                  <span class="input-group-addon">%</span>
                </div>
                </td>
              </tr>
                  ...
                  ?>
                    ...
                    <td class="text-right">
                      <div class="row">
                        ...
                        <span style="display:inline-block">
                          <a href="<?php echo base_url('Decovert_Bank/download_collateralexcemption/').$key4['col_id']; ?>" class="btn btn-sm btn-primary waves-effect waves-light downloadv" data-toggle="tooltip" title="Download" id="collateral_downloadv-<?php echo $key4['col_id'];?>"> <i class="fa fa-cloud-download"></i></a>
                        </span>
                         </div>
                      </div>
                     </td>
  ...
  <div class="modal-dialog modal-full-height modal-left modal-notify modal-info"> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title heading lead">DOCUMENTS SYSTEMES Files</h4>
      </div>
 ...
 /*Additional Information Type d’identification split Section */
  $('#type_id').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Decovert_Bank/changetypeid') ?>",
...
/*Employment Information Secteurs split Section */
  $('#secteurs').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Decovert_Bank/changesecteurs') ?>",
            data:{'ai_id':ai_id,'customar_id':customar_id,'select_val': select_val },
             beforeSend: function(){
  ...
  $('#cat_employeurs').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Decovert_Bank/changecat_employeurs') ?>",
  ...
  $('#typeofcontract').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Decovert_Bank/change_type_of_contract') ?>",
            data:{'emp_infoid':emp_infoid,'customar_id':customar_id,'select_val': select_val },
             beforeSend: function(){
  ...
  $('#obj_credit').on('change',function(){    
    ...
    if(select_val!=""){
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Decovert_Bank/change_objet_of_the_credit') ?>",
...
<script type="text/javascript">
  $('#frais_de_dossier').on('keyup click', function(){
   ...
   $("#frais_de_dossier").css("background-color", "#e9ffe9");
    ...
    $.ajax({
      type: "POST", 
        url:'<?php echo base_url("Decovert_Bank/postupdate_fees");?>',
  ...
  $(document).ready(function(){ 
    ...
    $("#decouvert_monthly").val(0);
        ...
        setTimeout(function() {     
            $.ajax({
            type: "POST", 
                url:'<?php echo base_url("Decovert_Bank/riskanalysis_current_monthly_credit");?>',
    ...
    $(document).on("keyup click", ".qty2", function() {    
        ...
        setTimeout(function() {     
            $.ajax({
            type: "POST", 
                url:'<?php echo base_url("Decovert_Bank/riskanalysis_monthly_payment_new_loan");?>',
                data:$.trim(serializedFormR),
                //contentType: false,
                cache: false,
                //processData: false,
    ...
    var serializedFormRf =form.serialize(); 
        ...
        setTimeout(function() {     
            $.ajax({
            type: "POST", 
                url:'<?php echo base_url("Decovert_Bank/riskanalysis_financial_situation");?>',
...
$("#button_1").on("click", function(e) {  
    var form = $("#loanEditForm");           
     ...
     $.ajax({
        type:'POST',
        url:'<?php echo base_url("Decovert_Bank/edit_loan");?>',
...
//$('#loanEditFormdetais').submit(function(){    
    ...
    /*$('#loan_tax').change(function() {  
        ...
        var url = "<?php //echo base_url('Decovert_Bank/rangeofTax');?>";     
...
$('.getdataajax').html('');
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo base_url("Decovert_Bank/interaction_email");?>',
        data:eformData,
        beforeSend: function(){         
...
$(document).ready(function(){   
    ...
    var customar_id ='<?php echo $appformD[0]['customar_id'];?>';       
      ...
      form_data.append('customar_id',customar_id);
            ...
            $.ajax({
                url:"<?php echo base_url('Decovert_Bank/uploadfile_split');?>",
                method:"POST",
                data: form_data,
                contentType: false,
                cache: false,
    ...
    $(document).on('change', '#check_list_customer_documents', function(){
      ...
      form_data.append('customar_id',customar_id2);
            ...
            $.ajax({
                url:"<?php echo base_url('Decovert_Bank/uploadfile_check_list');?>",
                method:"POST",
                data: form_data,
                contentType: false,
                cache: false,
...
$('.addbutton').click(function(){
    ...
    if(book_id !=""){       
        $.ajax({ 
            url:"<?php echo base_url('Decovert_Bank/addContractType');?>",
            data: {"postId": book_id},
            type: 'post',
            beforeSend:function(){
...
$(document).on('change', '#vehicule_uploadfile', function(){
    ...
    $.ajax({
        url:"<?php echo base_url('Decovert_Bank/uploadfile_collateral_vehicule');?>",
        method:"POST",
        data: formdata,
        contentType: false,
        cache: false,
...
$(document).on('change', '#deposit_files', function(){
    ...
    $.ajax({
        url:"<?php echo base_url('Decovert_Bank/uploadfile_collateral_deposit');?>",
        method:"POST",
        data: formdata,
        contentType: false,
        cache: false,
...
$(document).on('change', '#upload_maison', function(){
    ...
    $.ajax({
        url:"<?php echo base_url('Decovert_Bank/uploadfile_collateral_maison');?>",
        method:"POST",
        data: formdata,
        contentType: false,
        cache: false,
...
$(document).on('change', '#excemption_files', function(){   
    ...
    $.ajax({
        url:"<?php echo base_url('Decovert_Bank/uploadfile_collateral_excemption');?>",
        method:"POST",
        data: formdata,
        contentType: false,
        cache: false,
...
$(document).ready(function(){       
    ...
    var customar_id ='<?php echo $appformD[0]['customar_id'];?>';  
      ...
      form_data.append('customar_id', customar_id);      
            ...
            $.ajax({
                url:"<?php echo base_url('Decovert_Bank/uploadfile_risk_analysis');?>",
                method:"POST",
                data: form_data,
                contentType: false,
                cache: false,
...
<script type="text/javascript">
  $("#commentsubmit").on("click", function(e) {    
    var form = $("#DecisionStatus");           
     ...
     $.ajax({
        type:'POST',
        url:'<?php echo base_url("Decovert_Bank/comment_manager");?>',
        data: $.trim(serializedFormStr),
        beforeSend: function(){         
      ...
      if (confirm("Are You Sure You Want to Do This!")) {   
        $("#optionsRadios0001").prop("checked", true);
         ...
         $("#vehicule_uploadfile").attr("disabled", false);
          ...
          url:'<?php echo base_url("Decovert_Bank/enableddisabled");?>',
          cache: false,
