      ...
      <div id="content-header" class="clearfix">
        <div class="col-md-9">
          <ol class="breadcrumb">
            ...
            <li><a href=" <?php echo base_url('PP_Consumer_Global_User/credit_scholar_loan');?>">CREDIT SCHOLAIRE</a></li>            
                              ...
                              <div class="bg-header">
                                <div class="well well-sm well-primary" style="background-color:transparent !important">
                                  ...
                                  <div class="row well_row">
                                    ...
                                    <div class="col-xs-2 no-padding">CFA <?php echo number_format($appformD[0]['loan_amt'],0,',',' ');?></div>
                                    <div class="col-xs-2 bold no-padding">Date of Last Payment:</div>
                                    <div class="col-xs-2 no-padding"><?php echo $DateofLastPayment;?></div>
                                    <div class="col-xs-2 bold no-padding">Total Payment:</div>
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label>Objet du crédit </label>
									                      <h3 id="tab-details"><span><?php echo "consomation" ?: '-';?></span></h3>
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        <h3 id="tab-details"><span>CFA <?php echo number_format($otherinfo[0]['frais_de_dossier'],0,',',' ') ?: '0';?></span></h3>
                                      </div>
                                    </div>
                                  </div>
