		...
		<div class="col-lg-12">
			...
			<div id="content-header" class="clearfix">
				<div class="pull-left">
					...
					<li><a href="<?php echo base_url('PP_Consumer_Approval_Bank/customer_details/').$this->uri->segment(3);?>">DÉTAILS DU CLIENT</a></li>
			...
			<div class="row">
				<div class="col-lg-3 pull-right">
					...
					<a href="<?php echo base_url('PP_Credit_Scholar/amortization_vewpdf/').$this->uri->segment(3);?>" class="btn btn-primary" align='middle'> <i class="fa fa-cloud-download"></i> TELECHARGER EN PDF</a>									
				</div>
			</div>
