		...
		<div class="col-lg-12">
			...
			<div id="content-header" class="clearfix">
				<div class="pull-left">
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url('Decovert_Bank/customer_details/'.$this->uri->segment(3));?>">Customer Details</a></li>
			...
			<div class="main-box-body clearfix">
				...
				<div class="col-lg-2 pull-right">
					<a href="<?php echo base_url('Decovert_Loans/Decovert_amortization_download_pdf/').$this->uri->segment(3);?>" class="btn btn-primary" align='middle'> <i class="fa fa-cloud-download"></i> Download  PDF</a>
				</div>
			</div>
