...
class ConvertNumberToText{
	private $unite = array("zéro","un","deux","trois","quatre","cinq","six","sept","huit","neuf");
	...
	public function Convert($number){
		...
		if(strlen($number)>24) return "Le nombre à traiter est trop grand";
