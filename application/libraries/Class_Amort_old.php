...
function tegcal($npmts,$loan_amt,$pmnt,$mrate){
    $ebal = $loan_amt;
$ccint =0.0;
$cpmnt = 0.0;
$totalCss=0;
...
$withoutTax=$cpmnt-($totalTax/$months);
// echo $this->amount;
$lastparameter=$this->amount-37000;
...
print "<dl><dt>MONTANT DU PRET</dt><dt>(in FCFA, no commas)</dt>";
