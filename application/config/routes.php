...
// New upate : 19-08-2020 Gopal
$route['PP_FETES_A_LA_CARTE'] = 'customer_products/Credit_Conso';
$route['PP_FETES_A_LA_CARTE/(:any)'] = 'customer_products/Credit_Conso/$1';
$route['PP_FETES_A_LA_CARTE/(:any)/(:any)'] = 'customer_products/Credit_Conso/$1/$2';
$route['PP_FETES_A_LA_CARTE/(:any)/(:any)/(:any)'] = 'customer_products/Credit_Conso/$1/$2/$3';

// New upate : 02-09-2020 Gopal
$route['PP_CONGES_A_LA_CARTE'] = 'customer_products/Credit_Scolair';
$route['PP_CONGES_A_LA_CARTE/(:any)'] = 'customer_products/Credit_Scolair/$1';
$route['PP_CONGES_A_LA_CARTE/(:any)/(:any)'] = 'customer_products/Credit_Scolair/$1/$2';
$route['PP_CONGES_A_LA_CARTE/(:any)/(:any)/(:any)'] = 'customer_products/Credit_Scolair/$1/$2/$3';

// New update : 25-01-2021 Karuna
$route['PP_CREDIT_CONFORT'] = 'customer_products/Credit_Confort';
$route['PP_CREDIT_CONFORT/(:any)'] = 'customer_products/Credit_Confort/$1';
$route['PP_CREDIT_CONFORT/(:any)/(:any)'] = 'customer_products/Credit_Confort/$1/$2';
$route['PP_CREDIT_CONFORT/(:any)/(:any)/(:any)'] = 'customer_products/Credit_Confort/$1/$2/$3';

// New update : 13-05-2020
$route['Customer_Product'] = 'customer_products/Customer_Product';
$route['Customer_Product/(:any)'] = 'customer_products/Customer_Product/$1';
$route['Customer_Product/(:any)/(:any)'] = 'customer_products/Customer_Product/$1/$2';

// New upate : 18-05-2020
$route['Customer_Product/(:any)/(:any)/(:any)'] = 'customer_products/Customer_Product/$1/$2/$3';

// New upate : 19-05-2020
$route['Customer_Product/(:any)/(:any)/(:any)/(:any)'] = 'customer_products/Customer_Product/$1/$2/$3/$4';
$route['operational_dashboard'] = 'SuperAdmin_dashboard/operational_dashboard';
$route['admin/settings'] = 'Admin_Dashboard/settings';
$route['mark_as_read'] = 'SuperAdmin_dashboard/mark_as_read';
$route['view_notifications'] = 'SuperAdmin_dashboard/view_notifications';
