...
class Reports extends Admin_Controller 
{
	...
	public function export_report()
	{
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('P1', 'Date De Demande Prêt');
        $objPHPExcel->getActiveSheet()->SetCellValue('Q1', 'Montant Du Prêt');
        $objPHPExcel->getActiveSheet()->SetCellValue('R1', 'Taux Interet');
        $objPHPExcel->getActiveSheet()->SetCellValue('S1', 'Durée'); 
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('AE1', 'SCO/DR - Délégué Crédit 2');
        $objPHPExcel->getActiveSheet()->SetCellValue('AF1', 'Date Validation SCO/DR - Délégué Crédit 2');
	...
	public function get_label_status($status){
	    ...
	    switch ($status) {
          ...
          case "Avis défavorable":
           $label = '<span class="label label-danger">Avis Défavorable</span>';
            break;
